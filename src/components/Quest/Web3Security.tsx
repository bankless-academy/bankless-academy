        ...
        <>
          <Box display={isSmallScreen ? 'block' : 'flex'}>
            <Image
              ...
              src="/lesson/images/web3-security/quest/elon-musk-scam.jpg"
            />
            <Image
              ...
              src="/lesson/images/web3-security/quest/nitro-discord-scam.png"
            />
          </Box>
          <Box display={isSmallScreen ? 'block' : 'flex'} mt="0 !important">
            <Image
              ...
              src="/lesson/images/web3-security/quest/collabland-join.jpg"
            />
            <Image
              ...
              src="/lesson/images/web3-security/quest/metamask-wallets-scam.jpg"
            />
          </Box>
          <h2>
