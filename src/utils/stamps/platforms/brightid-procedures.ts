// SOURCE: https://github.com/gitcoinco/passport/blob/main/platforms/src/Brightid/procedures/brightid.ts
...
const CONTEXT = process.env.NEXT_PUBLIC_BRIGHTID_CLIENT_ID;
