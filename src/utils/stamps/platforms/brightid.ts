// SOURCE: https://github.com/gitcoinco/passport/blob/main/platforms/src/Brightid/Providers/brightid.ts

// ----- Types
import { ProviderExternalVerificationError, type Provider, type ProviderOptions } from "../types";
import type { RequestPayload, VerifiedPayload, BrightIdVerificationResponse } from "../passport-types";

// --- verifyMethod in providers
import { verifyBrightidContextId } from "./brightid-procedures";
