...
import { clearCacheSession, initCacheSession, loadCacheSession, PlatformSession } from "../platform-cache";
import { ProviderContext } from "../passport-types";
...
const handleTwitterSdkRequestError = (dataLabel: string, error: any): void => {
  ...
  if (error instanceof ApiResponseError) {
    ...
    } catch { console.error('JSON error') }
    throw new ProviderExternalVerificationError(
