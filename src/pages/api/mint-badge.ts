...
export default async function handler(
  ...
  try {
    ...
    try {
      ...
      // Construct multicall data with dynamic badgeId
      const multicallData = [
        `${badgeId.toString(16).padStart(2, '0')}`
      ]
