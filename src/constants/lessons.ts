...
const LESSONS: LessonType[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>In web2 a password is just one part of security, but in web3 the seed phrase is <strong>everything. </strong>Do <strong>not</strong> store a web3 <span class="tooltip" definition="Group of random words generated by a wallet on setup, they act as the master key to ALL accounts controlled by that wallet. NEVER SHARE YOUR SEED PHRASE WITH ANYONE FOR ANY REASON.">seed phrase</span> in a password manager - if you do, it takes just one password breach to obtain all of your web3 assets.</p><p>There are many methods for storing seed phrases securely, but a good start is to only keep it on physical media (laminated paper or similar) and store it in a water- and fire-proof safe in your own home. </p><p>Poor places to store seed phrases include:</p><ul><li>In a filing cabinet</li><li>In your bag</li><li>At your workplace</li><li>A drawer, cupboard, or shelf</li></ul><p>Wherever you store your seed phrase, you should ensure that only you have access to it and that it is protected from loss and destruction. You never know what might happen in the future!</p></div>'
      },
      {
        type: 'LEARN',
  ...
  },
  {
    ...
    imageLinks: [
      ...
      '/lesson/banklessdao-constitution/membership-levels-0eacf95a.png',
      '/lesson/banklessdao-constitution/membership-levels-3a542edf.png',
