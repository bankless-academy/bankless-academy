...
const LESSONS: LessonType[] = [
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>⌛ Have you ever had to wait several working days to send money internationally, while paying 3-5% in fees?</p><hr><p>Email simplified sending letters by removing the need for a post office. In a similar way, Bitcoin has streamlined sending money by removing the need for banks.</p><ul><li>⚡ Send money globally, 24/7. No paperwork, no bank approval, no downtime.</li><li>⚙️ Confirmation takes minutes to an hour, and fees rise and fall with network demand.</li><li>📡 Access Bitcoin from anywhere with an internet connection.</li></ul><p>For instant, low-fee everyday payments, Bitcoin also has a fast-payments layer called the Lightning Network.</p><p>In the same way that you have an email address, a single Bitcoin address is necessary to receive Bitcoin. By default it looks like this: <em>bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4</em></p><p>You’ll manage your account using <code>cryptocurrency wallet</code> software on your phone or computer. It’s the easiest “bank account” you’ll ever set up. No appointment or ID required!</p></div><div class="bloc2"><img src=\'/images/bitcoin-basics/bitcoin-its-like-emailing-money-2e2fb8ad.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Correct! Your public key allows others to find you, while only your private key lets you in.',
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Try again! If your password manager is hacked, your recovery phrase could be leaked.'
          ],
          id: 'wallet-basics-7'
        }
      },
