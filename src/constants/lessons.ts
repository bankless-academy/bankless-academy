  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Considering the number of scaling solutions we could help guide our Explorers towards, we felt that Optimism, an EVM-equivalent Layer 2 protocol powered by Optimistic Rollups, was the best fit. Using dApps on it should feel familiar, and because it uses Rollups, you can use ETH to pay for your low-cost transactions.</p><p>Yet that’s not what makes Optimism a unique scaling solution. Optimism, influenced by Ethereum whitepaper author Vitalik Buterin - and others - has put a focus on funding public goods front-and-center as its mission. Optimism allocated a portion of its initial token supply and uses transaction fees to fund a robust retroactive public goods funding program. As a <code>public good</code>, Bankless Academy naturally aligns with Optimism. </p><p>Optimism is not just a platform that relies on the Optimistic Rollup; it’s also a metaphor for the power of technology to solve existing problems and to show us new ways of transacting, of living. And that should make us all optimistic. 🙂</p></div><div class="bloc2"><img src=\'/lesson/layer-2-blockchains/start-your-l2-journey-with-optimism--5b161e31.png\'></div>'
      },
      {
        type: 'QUEST',
