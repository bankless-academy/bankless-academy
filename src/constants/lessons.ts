...
const LESSONS: LessonType[] = [
  ...
  },
  {
    ...
    marketingDescription: 'How the most common scams in web3 work and how to stay safe from them.',
    poapEventId: null,
    duration: 15,
    learnings: '',
    difficulty: 'Easy',
    description: 'How the most common scams in web3 work and how to stay safe from them.',
    name: 'Web3 Security',
    quest: 'Web3Security',
    ...
    imageLinks: [
      ...
      '/lesson/web3-security/money-in-web3--0c30ed94.png',
      '/lesson/web3-security/two-factor-authentication-5fa98d89.png',
      '/lesson/web3-security/social-engineering-scams-c1c5fb7f.png',
      '/lesson/web3-security/social-media-safety-4f6f94f9.png',
      '/lesson/web3-security/social-media-safety-b96bceed.png',
    ...
    slides: [
      ...
      },
      {
        ...
        title: 'Social Media Safety',
        content: '<div class="bloc-ab"><div class="bloc-a"><img src=\'/lesson/web3-security/social-media-safety-4f6f94f9.png\'></div><div class="bloc-b"><p><strong>Social Media Red Flags</strong><strong>:</strong></p><p>🚩 <strong>Language and grammar errors:</strong> They’re/their/there, etc.</p><p>🚩 <strong>FOMO:</strong> “Don’t miss out!”</p><p>🚩 <strong>Impersonation:</strong> an admin, support desk, Vitalik Buterin, Elon Musk, etc.</p><p>🚩 <strong>Guaranteed returns: </strong>Nothing is guaranteed in crypto.</p><p>🚩 <strong>Un</strong><strong>requested links and offers, </strong>especially via direct message.</p></div></div><div class="bloc-ab"><div class="bloc-a"><img src=\'/lesson/web3-security/social-media-safety-b96bceed.png\'></div><div class="bloc-b"><p><strong>Social Media Best Practices:</strong></p><ul><li>Keep in mind: ‘If they have to direct message me to sell their product, I probably don’t want it.’</li><li>Check the project follower and member count - though these do not guarantee project legitimacy, quality, or stability.</li><li>Verify everything with an outside source, like another official project account.</li><li>If you’re ever uncertain, check with reputable members from a community you trust - and ask in public. </li></ul></div></div>'
      },
      {
        type: 'LEARN',
