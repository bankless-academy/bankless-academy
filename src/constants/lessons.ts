...
const LESSONS: LessonType[] = [
    ...
    slides: [
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Correct! The more money there is, the less each unit is worth.',
            'Try again! A bigger supply makes each unit worth less, not more.',
            'Try again! New money dilutes the value of the money people already hold.'
          ],
          id: 'bitcoin-basics-1'
        }
      },
      ...
      },
      {
        ...
        title: 'Enter Bitcoin',
        content: '<div class="bloc1"><p><code>Satoshi Nakamoto</code> thought that money was too important to be controlled by just a few people. They wanted to create a type of money that could be fair and reliable for everyone.</p><p>Enter Bitcoin (<code>BTC</code>): a digital currency that operates beyond the traditional banking system.</p><ul><li>⛓️ It’s <code>peer-to-peer</code>: It connects people directly to each other. Automated using <code>blockchain technology</code>, it removes need for institutions to facilitate storage or transactions. Advocates call it “a set of rules with no rulers”.</li><li>💎 It’s <code>scarce</code>: With no central bank issuing unlimited new money, Bitcoin has a stable, predictable monetary policy that honors long-term saving.</li><li>✊ It’s <code>self-custodial</code>: It can be held without institutions hosting transfers or storage. The network records who owns what, and your <code>private keys</code> prove it: only the key holder can move the coins.</li></ul><p>For its qualities, Bitcoin has earned the nickname “digital gold”.</p></div><div class="bloc2"><img src=\'/images/bitcoin-basics/enter-bitcoin-b108517c.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: '8462f7e2e0694a82a0e6dc126c81b907',
        title: 'Digital Gold: Scarcity',
        content: '<div class="bloc1"><p>📉 Do you find it difficult to keep up with rising costs?</p><p>Scarcity in Bitcoin refers to there being a cap on how many Bitcoins can ever exist: a maximum of 21 million. This <code>max supply</code> is embedded in its code, making Bitcoin rare, much like gold.</p><p>New currency still enters the <code>circulating supply</code> through a laborious process called <code>cryptocurrency mining</code>. Roughly every four years, this new issuance is cut in half (the <code>halving</code>), shrinking toward zero as the cap approaches, so miners rely more on transaction fees over time.</p><p>Bitcoin\'s fixed <code>monetary policy</code> makes it attractive for preserving value in the long term. Since 2024, regulated funds (<code>spot ETFs</code>) have let traditional investors hold Bitcoin, strengthening its “digital gold” role.</p><p>Its short term value remains volatile due to market speculation.</p></div><div class="bloc2"><img src=\'/images/bitcoin-basics/digital-gold-scarcity-8c8905f7.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Try again! Bitcoin’s price is volatile in the short term; its fixed supply supports long-term value.',
            'Try again! Bitcoin has no central bank; its supply rules are fixed in code.'
          ],
          id: 'bitcoin-basics-2'
        }
      },
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>⌛ Have you ever had to wait several working days to send money internationally, while paying 3-5% in fees?</p><p>Email simplified sending letters by removing the need for a post office. In a similar way, Bitcoin has streamlined sending money by removing the need for banks.</p><ul><li>⚡ Send money globally, 24/7. No paperwork, no bank approval, no downtime.</li><li>⚙️ Confirmation takes minutes to an hour; a fast-payments layer, the <code>Lightning Network</code>, handles instant everyday payments.</li><li>📡 Access Bitcoin from anywhere with an internet connection.</li></ul><p>Like an email address, a Bitcoin address is all you need to receive bitcoin. It looks like this: <em>bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4</em></p><p>You’ll manage your funds with <code>cryptocurrency wallet</code> software on your phone or computer. No appointment or ID required!</p></div><div class="bloc2"><img src=\'/images/bitcoin-basics/bitcoin-its-like-emailing-money-2e2fb8ad.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            'True, but so are the other options. Pick the answer that covers them all.',
            'True, but so are the other options. Pick the answer that covers them all.',
            'True, but so are the other options. Pick the answer that covers them all.',
    ...
    slides: [
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Correct! Banks, social platforms, and app stores all sit in the middle, setting the rules and fees.',
            'Try again! Centralized services act as intermediaries for almost everything you do online.'
          ],
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>The solution starts with changing how the internet is connected.</p><p>In traditional internet services, information or money from one <code>peer</code> goes through an <code>intermediary</code> checkpoint before arriving at its destination. In theory, intermediaries can do whatever they want before the trade completes.</p><p><strong>Peer → Intermediary → Peer</strong></p><p>But there’s a second model, called <code>peer-to-peer</code> networking. It replaces intermediary services with automated, transparent computer code.</p><p><strong>Peer → Automation → Peer</strong></p><p>It’s like replacing your intermediary with a self-service kiosk. Services become more predictable, fees go down, and users regain control.</p><p>As we’ll see, a peer-to-peer internet changes everything.</p></div><div class="bloc2"><img src=\'/images/ethereum-basics/peer-to-peer-trades-f043c3c0.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>⚖️ <strong>Wouldn’t the internet be a better place if the same rules applied to everyone?</strong></p><p>Think of Ethereum as a digital city, where everything (from businesses to public services) is run by self-service, transparent systems. There are no intermediaries, and anyone can inspect how each system works.</p><p>Transactions in the city are noted on a public record called the <code>Ethereum blockchain</code>. The blockchain tracks and stores digital property in the city, removing the need for another classic intermediary: the bank!</p><p>Every transaction pays a small fee. Most of that fee is destroyed, which can make the city’s currency, <code>ether</code>, scarcer as the city gets busier. A small tip rewards the computer that processes your transaction.</p><p>The city’s rules aren’t set by any company: changes are agreed on openly by builders, researchers, and users. Transparent code has replaced kings, and nobody is above the rules.</p></div><div class="bloc2"><img src=\'/images/ethereum-basics/ethereum-the-open-internet-ab794154.svg\'></div>'
      },
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>⌛ <strong>Do you want a faster, cheaper way to transfer money internationally?</strong></p><hr><p>Ethereum makes it possible for you to send and store <code>crypto</code> without intermediaries, with better services at lower costs.</p><p>⚡ With crypto, you can send money anywhere in the world in seconds. Most everyday activity now happens on <code>Layer 2</code> networks, faster and cheaper lanes built on top of Ethereum, where a transfer can cost as little as one cent. Compare this to sending money through a bank, where they can charge you 3-4% in fees, and take 1-5 days.</p><p>🔐 You’re the only person with access to your Ethereum account. There’s no intermediary loaning out your savings or controlling what you do with your money. Funds are stored in your personal <code>crypto wallet</code>, the same one you used to connect to a dApp earlier.</p><p>On Ethereum, you’re your own bank, and you feel like it!</p></div><div class="bloc2"><img src=\'/images/ethereum-basics/a-global-banking-system-5a241dfc.svg\'></div>'
      },
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Correct. You can go “Bankless”! You hold your own funds, with lower fees and more control.',
            'Try again. Only you can access your crypto wallet, so no bank sits between you and your money.'
          ],
    ...
    slides: [
      {
        ...
        title: 'Wallet Intro',
        content: '<div class="bloc1"><p><strong>Greetings Bankless Explorer!</strong></p><p>It’s time to dive deeper on your journey into the blockchain multiverse. Every Explorer in this space eventually needs to create a crypto wallet.</p><p>Wallets are kind of like the accounts from the <code>web2</code> internet that you’re used to. You’ll use a wallet to log into the blockchain ecosystem, also known as <code>web3</code>, where you’ll be able to use <code>cryptocurrency</code> and connect to <code>blockchain apps</code>!</p><p>In this lesson, we’ll introduce you to wallets, how they work, and how to keep your cryptocurrency secure. We’ll end with a guide on how to set one up and access <strong>the Ethereum blockchain, the home of Bankless Academy.</strong></p></div><div class="bloc2"><img src=\'/images/welcome-explorer.png\'></div>'
      },
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Try again! Your wallet is hosted on a blockchain.',
            'Try again! Cryptocurrencies are something you hold in your wallet.',
            'Try again! Digital collectibles are something you hold in your wallet.',
            'Correct! Wallets are accounts used to interact with blockchains.'
          ],
          id: 'wallet-basics-1'
        }
      },
      {
        ...
        content: '<div class="bloc1"><p>Here is one of the most important things to understand about <code>web3</code> wallets:<br><strong>There are no “password resets” or “password changes”.</strong></p><p>Most of us are used to these features. If we forget a password, we click a button, do a few things, and get a new password. Easy.</p><p>Not so with crypto wallets. Because of how blockchains work, wallets are assigned an “address” and a complex “password” when they’re created, and you do not choose these.</p><p>This address and password combination cannot be changed, although you can always create a new wallet if you need to. Some newer wallets add recovery features, but never rely on that. Let’s learn a bit more about these special addresses and passwords, so that we can feel confident using them!</p></div>'
      },
      {
        type: 'LEARN',
        notionId: 'fc8b92080fd14c938e419ca401e15634',
        title: 'Your wallet’s public key',
        content: '<div class="bloc1"><p>Your wallet’s <code>address</code> is created from its <code>public key</code>. Think of the address as your username: it often looks like a random series of letters and numbers.</p><p>Example: <em>0xe1887fF140BfA9D3b45D0B2077b7471124acD242</em></p><p>It is possible to create easier to remember versions of this with some <code>web3</code> services, but that’s a lesson for another time.</p><p>You can also think of your address like a house address. It is public, anyone can see it, and it tells others where they can send you crypto assets, without revealing anything personal about you.</p><p>It is perfectly safe to share your wallet’s <strong>address</strong>.</p><p><strong>Note:</strong> A single wallet app can hold multiple public/<code>private key</code> pairs.</p></div><div class="bloc2"><img src=\'/images/wallet-basics/your-wallets-public-key-87828c3e.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: '5f1d4d9b65f740c4af2dc65510c417ef',
        title: 'Your wallet’s private key',
        content: '<div class="bloc1"><p>If your address is like a house address, then the <code>private key</code> is like the key to the front door. It’s the “password” to your funds and assets.</p><p>Example: <em>eceac283e04f121cbd40b69e16ab9dec0220df80bf092a4c72b53e69cf74d215</em></p><p><strong>It’s never safe to share this key: you could lose your wallet and everything in it.</strong></p><p>Most people recommend that you do not even save it digitally. Whoever has access to a private key has access to whatever is in the <code>wallet</code>.</p><p>This is more than just a password. You cannot reset it if you lose access to it.</p><p>Luckily, most <code>blockchain apps</code> do not require you to type a long, complicated string of characters every time you need to send funds or sign a blockchain transaction. The private key usually operates quietly in the background.</p></div><div class="bloc2"><img src=\'/images/wallet-basics/your-wallets-private-key-0d84ad39.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            'Try again! Unlike a bank account number, your private key shouldn’t be shared with others.',
            'Try again! Unlike a zip code, your private key shouldn’t be shared with others.',
            'Correct! Your address lets others find you, while only your private key lets you in.',
            'Try again! These are examples of public & private information, but they’re unrelated.'
          ],
          id: 'wallet-basics-2'
        }
      },
      {
        ...
        content: '<div class="bloc1"><p>When you set up a new wallet, your wallet app will provide you with a <code>recovery phrase</code>.</p><p>Also called a “seed phrase” or “secret phrase”, this string of words can be used to access your wallet and crypto assets if:</p><ul><li>Your <code>wallet app</code> or device fails unexpectedly or is damaged.</li><li>Your device has been lost or stolen.</li><li>You want to access your wallet on multiple devices.</li></ul><p>Most recovery phrases are a list of 12 to 24 words that represent a unique piece of data. This data is used to generate both the <code>public key</code> and <code>private key</code> for your wallet.</p><p>Wallet recovery does <strong>not</strong> change or reset the keys.</p><p>Your recovery phrase is like a master key: it can recreate every key pair in your wallet. <strong>Never share your recovery phrase.</strong></p></div><div class="bloc2"><img src=\'/images/wallet-basics/recovery-phrase-c614c36c.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            'Try again!',
            'Correct! Recovery phrases grant access to your wallet, even on multiple devices.'
          ],
          id: 'wallet-basics-3'
        }
      },
      {
        ...
        content: '<div class="bloc1"><p>Just as there are many types of computer software, there many types of wallet. Let’s look at the four main categories:</p><ul><li>🏦 <strong>Custodial wallets:</strong> where a third party is responsible for your private keys.</li><li>👤 <strong>Self-custody (non-custodial) wallets:</strong> where you are responsible for your private keys.</li></ul><p>There are two styles of <code>self-custody wallet</code>:</p><ul><li>🔥 <strong>Hot wallets:</strong> software on your desktop or phone.</li><li>🧊 <strong>Cold wallets:</strong> a piece of hardware (like a memory stick) you store somewhere safe.</li></ul><p>You may also hear about <code>smart wallets</code>: an emerging type that runs code, enabling extras like passkey logins and account recovery.</p><p>Each wallet serves a different use-case. Don’t worry, we’ll only be creating one wallet today.</p></div><div class="bloc2"><img src=\'/images/welcome-explorer.png\'></div>'
      },
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Try again!',
            'Correct! Custodial wallets require trust in a third party (custodian) to control your private keys.'
          ],
          id: 'wallet-basics-4'
        }
      },
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Correct! With a self-custody wallet you are solely responsible for your private keys.',
            'Try again!'
          ],
          id: 'wallet-basics-5'
        }
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Try again! There are various trade-offs for each wallet type, with level of security being one of them.',
            'Try again! A hot wallet has an active internet connection which makes it more susceptible to digital attack.',
            'Try again! The third party holding the private keys can get hacked or go bankrupt.',
            'Correct! Cold wallets aren’t actively connected to the internet, making them more attack-resistant.'
          ],
          id: 'wallet-basics-6'
        }
      },
      {
        ...
        content: '<div class="bloc1"><p>Regardless if your <code>self-custody wallet</code> is hot or cold, there are many smart security practices you should develop.</p><p>🖊️ Record your <code>recovery phrase</code> on durable physical material (laminated paper, or even steel) and store it somewhere very safe. Never share it or your <code>private key</code> with anyone. <strong>It’s more than just a password.</strong></p><p>🔍 Double-check the details whenever you send funds or sign, even for small amounts: mistakes cannot be undone.</p><p>🔭 Research any <code>blockchain apps</code> you plan to use before connecting your wallet or signing their transactions.</p><p>💰 Use wallets with low amounts of funds to try new things and explore web3, and consider storing high value assets across multiple wallet accounts.</p><p>🛡️ Watch out for scams that trick you into signing harmful transactions or approvals: our <a href=\'https://app.banklessacademy.com/lessons/web3-security\'>Web3 Security</a> lesson shows how to spot them.</p></div><div class="bloc2"><img src=\'/images/welcome-explorer.png\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            'Correct! A safely stored physical backup with no digital traces is the safest storage option.',
            'Try again! If your computer is hacked, your recovery phrase could be found. Printing also opens many attack opportunities.',
            'Try again! If your phone is hacked, you could lose all assets in your wallet.',
            'Try again! A single password manager breach could expose it. Keep your phrase offline.'
          ],
          id: 'wallet-basics-7'
        }
      },
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Try again! This is true, but it isn’t the only correct answer.',
            'Try again! This describes the chain of blocks, but it isn’t the only correct answer.',
            'Correct! All three are true: a blockchain is a shared, uneditable record of transactions grouped into blocks, linked in sequence.'
          ],
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Not only are transactions included on a <code>blockchain</code> ledger unchangeable, they are also shared and distributed amongst a large network of computers. To make sure that no single entity has the power to change the data, copies of the blockchain ledger are stored on many computers, called <code>nodes</code>, across the network.</p><p>This shared data is what makes the blockchain ledger <code>decentralized</code>. No single authority or entity controls the data. Blockchains like Ethereum are also <code>public</code> because the ledger can be viewed by anyone.</p><p>For this lesson, just remember that the ledger data is shared across the many computers running the Ethereum network.</p></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Correct! Storing copies of the ledger on many nodes means no single entity has the power to control or change the data.',
            'Try again! A single server would be a central point of control. Copies of the ledger are stored on many nodes.'
          ],
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Healthy password usage and management is an important piece of everyday internet exploration.</p><p>Passwords should be different for each and every web2 service used online. This includes services like email, centralized exchanges, and other service accounts. It’s problematic if someone manages to get the ID + password for one account, but it’s far worse if that combination unlocks all of your accounts!</p><p><code>Password manager</code> applications like 1Password, Bitwarden, and KeePass securely store and encrypt multiple passwords; they can even generate new high-security passwords and store them automatically. The user just has to remember a single master password.</p><p>Do <strong>not</strong> store a web3 <code>seed phrase</code> in a password manager; it takes just one password breach to obtain all of your web3 assets and there is no one to recover your assets for you.</p></div>'
      },
      {
        type: 'QUIZ',
    ...
    slides: [
      {
        ...
        title: 'Introduction',
        content: '<div class="bloc1"><p>Problems emerge when more users want to use a <code>blockchain</code> network than it can handle. Large demand for <code>blockspace</code> can be temporary or can last as long as users continue to have a strong desire to use the blockchain. In times of high demand, users bid against each other to have their transactions processed quickly, and fees rise, pricing out users with less capital.</p><p>This lesson explores why Ethereum and other blockchains are subject to the <code>Blockchain Trilemma</code>, how the Trilemma is the root cause of the problems described above, and how the Trilemma affects Ethereum’s plans for serving the needs of all its users. We will look at the tradeoffs several blockchains have made concerning the Blockchain Trilemma, and what those tradeoffs mean for Academy Explorers.</p></div><div class="bloc2"><img src=\'/images/layer-1-blockchains/introduction-feee7790.svg\'></div>'
      },
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Security is the most foundational requirement for a public blockchain. Computers within a network (such as a blockchain network) must agree on what transactions have truly happened to work together; this agreement is called <code>consensus</code>. A blockchain is secure if attackers cannot disrupt the network from agreeing on that truth. Consensus algorithms are designed to resist these attacks.</p><p>Chains like Bitcoin that use <code>Proof of Work</code> consensus protect this agreement by making block production highly competitive; each block producer races to solve a math problem. The first to do so wins the right to create the next block and receives the monetary <code>block reward</code> that comes with it. Rewriting the chain’s recent history would require massive investments in computing power and energy, so an attacker would likely spend more than they’d gain.</p></div><div class="bloc2"><img src=\'/images/layer-1-blockchains/security-and-consensus-4e857c50.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>One potential form of attack on blockchain consensus is a <code>51% attack</code>; an attacker controlling the majority of a network’s consensus power can reverse recent transactions to spend the same coins twice, or censor new ones. They cannot fake signatures or spend anyone else’s funds. This majority means 51% of the computing power in Proof of Work consensus and 51% of the <code>stake</code> in Proof of Stake consensus, a massive capital investment. And in Proof of Stake, provable cheating such as signing two conflicting blocks gets that stake destroyed (called <code>slashing</code>); an attacker would likely lose more than they’d gain.</p><p>In <code>Proof of Stake</code> consensus, the block producer isn’t chosen through competition but is randomly assigned instead. Like with Proof of Work, the consensus algorithm ensures that any single entity cannot regularly “win” the right to create a new <code>block</code>.</p></div><div class="bloc2"><img src=\'/images/layer-1-blockchains/security-and-attacks-a73febc0.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            'Try again! The attack targets consensus itself: reversing or censoring transactions, not disrupting miners.',
            'Correct! Majority consensus power lets an attacker reverse recent transactions to spend coins twice, or block new ones.',
            'Try again! Anyone can create a new cryptocurrency without attacking an existing network.',
            'Try again! The other participants aren’t removed. Majority power is used to reverse or censor transactions.'
          ],
      ...
      },
      {
        ...
        title: 'Some Examples',
        content: '<div class="bloc1"><p>Each blockchain has its own approach to the trilemma, and each has made tradeoffs to focus on its goals. Bitcoin and Ethereum prioritize security and decentralization over scalability, leading to long transaction <code>finality time</code> for Bitcoin and limited <code>block space</code> on Ethereum. When demand to use <code>smart contracts</code> spikes, especially for DeFi, Ethereum fees rise; during peak demand in 2021, a single transaction could cost tens of dollars.</p><p>Rising fees provided an opening for <code>alternative Layer 1</code>’s like BNB Chain, which prioritized scalability over decentralization for higher <code>transaction throughput</code> and cheaper fees. Third-generation chains like Solana use novel methods to solve the trilemma, but all blockchains are still subject to these basic constraints. Each chain’s choice defines its ecosystem through the foundational effects that come from that choice.</p></div><div class="bloc2"><img src=\'/images/layer-1-blockchains/some-examples-30020a8d.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: '9381df55e11a40d182dbe4272d6fc5e0',
        title: 'So what can be done?',
        content: '<div class="bloc1"><p>So if Ethereum has prioritized high security and decentralization, how can it scale to serve the needs of all users as the global financial network it aims to become? The Ethereum roadmap explored two answers: <code>Layer 2</code>s and blockchain <code>sharding</code>.</p><p><code>Layer 2</code>s increase Ethereum scalability without compromising on the other two parts of the blockchain trilemma. They are an additional layer sitting on top of the main blockchain, relying on the main chain for security but allowing users to benefit from reduced fees and faster transactions. We will explore them in more detail in our Layer 2 lesson.</p><p><code>Sharding</code> would have split the blockchain into multiple parallel chains, like adding more lanes to a road. Ethereum set that plan aside for a simpler one: making block data cheaper for Layer 2s to use (added in 2024) and raising capacity step by step, without sacrificing security or decentralization.</p></div><div class="bloc2"><img src=\'/images/layer-1-blockchains/so-what-can-be-done-043c43fb.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>The Ethereum network keeps evolving its scalability without sacrificing the other aspects of the trilemma. The Merge to <code>Proof of Stake</code> consensus (2022) cut the network’s energy use by over 99%, and cheap block data for Layer 2s arrived in 2024. <strong>Scaling is continuous work: each upgrade makes Ethereum faster and cheaper to use while maintaining security and decentralization as core tenets.</strong> The Ethereum Foundation has an excellent webpage on the <a href=\'https://ethereum.org/roadmap/\'>Ethereum roadmap</a>.</p><p>Meanwhile, many <code>Layer 2</code> protocols build on top of Ethereum to help meet user demand without requiring updates to the Ethereum protocol itself. These Layer 2 protocols rely on Layer 1 Ethereum to provide decentralized security while they provide scalability; the diversity of Layer 2s makes a decentralized ecosystem! Leading <code>rollup</code>s include Arbitrum, OP Mainnet, and Base; Polygon PoS is a popular <code>sidechain</code> with its own separate security.</p></div><div class="bloc2"><img src=\'/images/layer-1-blockchains/the-future-of-ethereum-1f05c338.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Try again! This is part of the upgrades, but it isn’t the only one.',
            'Try again! This is part of the upgrades, but it isn’t the only one.',
            'Correct! Layer 2s and cheaper block data add scale, Proof of Stake cut energy use, and security and decentralization stay core tenets.'
          ],
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        title: 'Sidechains',
        content: '<div class="bloc1"><p>A <code>sidechain</code> is a separate blockchain that runs independently to Ethereum, but is connected to Ethereum Mainnet by a <code>bridge</code>. To migrate tokens, you lock them in a bridge contract on Mainnet, and equivalent tokens are minted on the sidechain. Importantly, this does NOT give your funds Ethereum’s security: the bridge and sidechain rely on the sidechain’s own validators. If either is compromised (like the $625M Ronin bridge hack of 2022), the locked funds can be stolen.</p><p>Sidechains are still subject to the Blockchain Trilemma. Their lower <code>gas</code> fees and faster transactions come from a smaller but more powerful validator set, trading some decentralization and security for scalability.</p><p>Sidechains like Polygon PoS regularly publish snapshots (“checkpoints”) to Ethereum. These give their history a form of finality and let users prove balances when exiting the bridge, but they don’t make sidechain funds as secure as Mainnet.</p></div><div class="bloc2"><img src=\'/images/layer-2-blockchains/sidechains-464f0191.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Optimism and Base, both EVM-equivalent Optimistic Rollups, are great L2s for Explorers to begin with. Using dApps on either chain feels similar to L1, just cheaper and faster, and both use ETH as gas. Your upcoming quest is the first step of your journey on Optimism or Base!</p><p>Both ecosystems are deeply influenced by Ethereum values, with Optimism known for <a href=\'https://optimism.mirror.xyz/wqk1Yeyn2OhV9paDzbRXvQ0m0JYDu2npbSkMClwk1rY\'>funding public goods</a> that add value to the ecosystem, such as free education from Bankless Academy.</p><p>Optimism and Base aren’t just platforms relying on Optimistic Rollups: they show how blockchains can solve real problems and open new ways of transacting and coordinating together. And that should make us all optimistic. 🙂</p></div><div class="bloc2"><img src=\'/images/layer-2-blockchains/start-your-layer-2-journey-with-optimism-or-base--54a0f80a.svg\'></div>'
      },
      {
        type: 'QUEST',
  ...
  },
  {
    ...
    learningActions: 'Choose the DeFi activity you want to explore\nSign your first message with your wallet',
    ...
    slides: [
      {
        ...
        title: 'DeFi Defined',
        content: '<div class="bloc1"><p>DeFi, short for <code>decentralized</code> finance, is the ecosystem of financial products, protocols, and applications that run on public <code>blockchain</code> networks.</p><p>DeFi is an established, open alternative to traditional financial services, with a range of tools for putting crypto assets to work. It offers opportunities beyond simply buying crypto on a centralized exchange, and lets anyone build a decentralized, Bankless lifestyle.</p></div><div class="bloc2"><img src=\'/images/intro-to-defi/defi-defined-759c5922.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: 'cced9d9d29ca4c6bb30b299e0752f9f5',
        title: 'Why DeFi?',
        content: '<div class="bloc1"><p>DeFi gives anyone with an internet connection access to sophisticated financial tools: investing, trading, lending and borrowing, and staking.</p><p>DeFi offers these tools to users transparently and openly. Anyone can look at the code and verify that the contract does what it says it does, unlike what banks do with your money behind closed doors.</p><p>And there is no institution in the middle deciding who gets in: no one can turn you away, freeze your account, or close it down.</p></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        title: 'Earning Yield',
        content: '<div class="bloc1"><p>Many <code>DeFi</code> protocols let you earn interest and other rewards by putting your crypto assets to work. You get access to financial products that would normally require a bank or financial services firm, without the paperwork, approval process, and other hassles of traditional finance.</p><p>DeFi is not free: you pay a small network fee for each transaction, and many protocols charge fees too. But these costs are typically lower and fully transparent, there is no bank overhead, and no institution can gatekeep your access or your earnings. This is why DeFi is popular.</p></div><div class="bloc2"><img src=\'/images/intro-to-defi/earning-yield-bc952747.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Try again! This is one way to earn yield, but it isn’t the only one.',
            'Correct! DeFi protocols let you earn both interest and other rewards by putting your crypto assets to work.',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p><code>DeFi</code> transactions are <code>permissionless</code>. This refers to a public <code>blockchain</code> that anyone can use to buy, sell, or trade assets. No third party controls or oversees activity. These transactions are carried out by decentralized applications, known as DApps.</p><p><code>DApps</code> and DeFi platforms operate 24/7, all over the world. Many run on <code>stablecoins</code>, tokens designed to hold a steady dollar value (see our <a href=\'https://app.banklessacademy.com/lessons/understanding-stablecoins\'>Understanding Stablecoins</a> lesson). We will introduce four of the most common activities in DeFi: investing, trading, lending and borrowing, and staking.</p></div><div class="bloc2"><img src=\'/images/intro-to-defi/what-you-can-do-with-defi-e1e865b5.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        title: 'Investing',
        content: '<div class="bloc1"><p>The most common <code>DeFi</code> transaction is to purchase some cryptocurrency with the expectation that it will be worth more in the future. This is known as investing.</p><p>HODL is a term used for keeping crypto assets for a long time. Depending on who you ask, the HODL meme either comes from a typo of HOLD or it stands for <strong>H</strong>old <strong>O</strong>n for <strong>D</strong>ear <strong>L</strong>ife.</p><p>DeFi can give early access to new coins and tokens before they are listed on centralized exchanges (CEX).</p></div><div class="bloc2"><img src=\'/images/intro-to-defi/investing-7c8b44ed.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>DeFi lending and borrowing offers loans without the need for a bank or intermediary institution. Instead, lending is done on a <code>peer-to-peer</code> level: <code>DApps</code> connect lenders and borrowers directly. The lender earns interest, and the borrower pays back the loan plus interest.</p><p>To borrow, you first deposit crypto worth more than the loan as <code>collateral</code>. If your collateral\'s value falls too far, it is automatically sold to repay the loan. This is called <code>liquidation</code>, and it is how DeFi loans stay safe without credit checks.</p></div><div class="bloc2"><img src=\'/images/intro-to-defi/lending-borrowing-b7d58dfa.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            'Try again! DeFi doesn\'t check your income: loans are secured by collateral instead.',
      ...
      },
      {
        ...
        title: 'Staking',
        content: '<div class="bloc1"><p><code>Staking</code> is often grouped with lending, but it is different: there is no borrower. You lock your <code>ether</code> to help keep the Ethereum network secure, and the network pays you rewards in return.</p><p>Staked funds can be locked for a period of time, and <code>validators</code> who misbehave lose part of their stake, so honesty pays. Centralized exchanges offer staking too, but DeFi gives you more options while you stay in control of your assets. Learn more in our <a href=\'https://app.banklessacademy.com/lessons/staking-on-ethereum\'>Staking on Ethereum</a> lesson.</p></div><div class="bloc2"><img src=\'/images/intro-to-defi/staking-8dbafcb8.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            'Try again! Trading is exchanging one token for another, not locking it to secure a network.',
            'Correct! Staking means locking your crypto to help secure a network, and earning rewards in return.',
            'Try again! Borrowing is taking out a loan against collateral, not helping secure a network.',
            'Try again! HODLing is simply keeping your crypto for a long time, not putting it to work.'
          ],
          id: 'intro-to-defi-7'
        }
      },
      {
        ...
        content: '<div class="bloc-ab"><div class="bloc-a"><img src=\'/images/intro-to-defi/defi-downsides-da1fdb68.svg\'></div><div class="bloc-b"><p><strong>Hackers</strong></p><p>Where there is money and technology, there are people looking for ways to hack the system. DeFi protocols and their users are frequent targets, so security habits matter.</p></div></div><div class="bloc-ab"><div class="bloc-a"><img src=\'/images/intro-to-defi/defi-downsides-d533aeef.svg\'></div><div class="bloc-b"><p><strong>Risk</strong></p><p>DeFi runs on code: <code>smart contracts</code>. An error or loophole in that code can be exploited to drain funds. Markets bring risk too: loans can be liquidated when prices fall, and <code>stablecoins</code> can lose their steady value.</p></div></div><div class="bloc-ab"><div class="bloc-a"><img src=\'/images/intro-to-defi/defi-downsides-0070f0e1.svg\'></div><div class="bloc-b"><p><strong>No recourse</strong></p><p>There is no customer support line, and no company or government agency to appeal to if something goes wrong. Lost or stolen funds usually cannot be reversed or refunded.</p></div></div>'
      },
      {
        type: 'QUIZ',
    ...
    slides: [
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Even CEXs have their risks. In 2022, the FTX exchange collapsed, with almost all users losing their deposits.',
            'Unless explicitly stated otherwise, a CEX owns your private keys.'
          ],
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'This is a quality of a dApp, but it isn’t the only one.',
            'This is a quality of a dApp, but it isn’t the only one.',
            'This is a quality of a dApp, but it isn’t the only one.',
            'Ethereum dApps are respected for their capacity to be permissionless, autonomous, and transparent.'
          ],
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>In traditional markets and <code>CEXs</code>, your custodian uses an <code>order book</code>: a database filled with buy and sell offers. The CEX connects your trade offer with another person’s. You are usually charged a base/scaling commission on your trade, and you’re also left wondering if the undisclosed matching method found you the best possible deal.</p><p>Most <code>DEXs</code> use ‘Automated Market Maker’ (<code>AMM</code>) technology, the most common design for token swaps: a system that prices your trade using a public algorithm. Some newer DEXs use order books or intent-based systems instead. As the AMM algorithm is open-source, anyone can understand, clone, and improve it, leading to healthy competition and constant innovation.</p><p>AMMs route user trades through <code>liquidity pools</code>, rather than directly matching user bids and asks. These communal token vaults accumulate and dispense tokens according to user interactions, with every step visible on the public blockchain.</p></div><div class="bloc2"><img src=\'/images/decentralized-exchanges/automated-market-makers-78ad7439.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        title: 'Token Swaps',
        content: '<div class="bloc1"><p>Cryptocurrency trades on the blockchain are called <code>token swaps</code>. These smart contract interactions convert one cryptocurrency to another using AMM <code>liquidity pools</code>. By forming a <code>trade route</code>, a pathway through the appropriate liquidity pools, a DEX smart contract exchanges your input token for your desired output token. Since pools usually hold only two tokens, and not every <code>token pair</code> has a pool, a route may pass through several pools to fulfil your swap.</p><p>To let a smart contract access our wallet, we grant it permission to withdraw funds up to a specified (or unlimited) amount. These <code>token allowances</code> let trusted contracts carry out transactions without our private key. Granting costs gas, so permissions stay open for future use: one reason to trade from one wallet and hold in another. We monitor and revoke allowances in our <a href=\'https://app.banklessacademy.com/lessons/managing-token-allowances\'>Managing Token Allowances</a> lesson!</p></div><div class="bloc2"><img src=\'/images/decentralized-exchanges/token-swaps-41ceb8e1.svg\'></div>'
      },
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Correct! You might pay a higher network fee, but the actions are bundled into one transaction.',
            'Incorrect, check the previous slide to understand why.'
          ],
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Incorrect, try again.',
            'Incorrect, try again.',
            'Right! Liquidity and volatility are generally inversely-correlated.'
          ],
      ...
      },
      {
        ...
        title: 'Platform Fees',
        content: '<div class="bloc1"><p>Both CEXs and DEXs charge fees for their services, and interacting with the blockchain is not free either. Here are five common costs to consider when choosing a platform.</p><p>🏷️ <strong>Platform fees:</strong> CEXs set their own trading commissions, while DEX pool fees vary by pool (commonly a fraction of a percent). The key difference: DEX fees are visible on-chain for anyone to check.</p><p>🌐 <strong>Network fees:</strong> Blockchains charge gas fees on top of the dApp transaction. You can minimize these costs by using the network during quiet periods. Etherscan.io has a real-time gas estimate tool for Ethereum Mainnet: <a href=\'https://etherscan.io/gastracker\'>Etherscan.io</a>. On Layer 2s, fees are far cheaper; compare networks at <a href=\'https://www.growthepie.com/\'>growthepie</a>.</p><p>📦 <strong>Bridge fees:</strong> Both CEXs and blockchain bridges charge for transferring cryptocurrency from one blockchain network to another. For CEXs, refer to their on-site information. Bridge dApps show a fee estimate before you confirm the transfer.</p><p>💹 <strong>Exchange rates:</strong> When buying cryptocurrency directly with fiat on a CEX or DEX, be wary of exchange rates that don’t reflect the market rate.</p><p>🧊 <strong>Slippage:</strong> Prices move fast, so DEXs leave room for fluctuation on a swap: this is called <code>slippage</code> (customizable, usually 0.5-2%). You may lose up to that value on a trade, but too low a setting can get your trade rejected.</p><p>Always do your own research before trading, so you understand a platform’s costs and trade-offs.</p></div>'
      },
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'This is a quality of a DEX, but it isn’t the only one.',
            'This is a quality of a DEX, but it isn’t the only one.',
            'This is a quality of a DEX, but it isn’t the only one.',
            'Right! DEXs offer all of these benefits over CEXs.'
          ],
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>There are many Decentralized Exchanges in DeFi, and some are better than others. Consider these five key factors when deciding on which DEX to use:</p><p>🥇 <strong>Legitimacy:</strong> Is the entity well known for its trustworthiness, quality, and longevity?</p><p>⛲ <strong>Liquidity:</strong> Is the liquidity pool <code>TVL</code> high enough to minimize price impact?</p><p>🖱️ <strong>Ease of use:</strong> Is the user interface easy to interact with?</p><p>🔐 <strong>Security:</strong> Have the smart contracts been audited by multiple auditors?</p><p>🎁 <strong>Rewards and Features:</strong> Are there loyalty rewards for using the exchange or providing liquidity? Can you vote in governance?</p><p>Notable names that score highly in these areas include Uniswap, Curve, Velodrome, and PancakeSwap. You can easily move from one DEX to another until you find a few favorites! For the lesson quest, we’re going to use Velodrome, a well-established DEX on the Optimism network. It’s easy to use, and because it’s on a Layer 2 the fees are far more reasonable!</p></div>'
      },
      {
        type: 'LEARN',
        notionId: '786352ac183a48e78eb74519e0b87117',
        title: 'DEX Best Practices',
        content: '<div class="bloc1"><p>Before you interact with a dApp, there are some best practices you should follow to keep your funds safe:</p><p>👩‍💻 Verify a dApp’s link via the official project X (Twitter) account (gold check mark) or a trusted third party, then bookmark it. Many DeFi scams begin with a fake link, even on popular search engines.</p><p>🔓 When granting on-chain <code>token allowances</code>, limit the allowance to your trade amount. Many DEXs now use signature-based approvals covering just your trade: see <a href=\'https://app.banklessacademy.com/lessons/managing-token-allowances\'>Managing Token Allowances</a>.</p><p>♟️ Don’t interact with dApps from your HODL wallet; use a separate wallet just for dApps. Our <a href=\'https://app.banklessacademy.com/lessons/web3-security\'>Web3 Security lesson</a> covers wallet strategies.</p><p>Now you’re ready to interact with a Decentralized Exchange!</p></div><div class="bloc2"><img src=\'/images/decentralized-exchanges/dex-best-practices-62cbc83b.svg\'></div>'
      },
      {
        type: 'QUIZ',
    ...
    slides: [
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Correct! This “slashing” punishes provable cheating. Being offline only costs a small penalty.',
            'Try again! Provable cheating is punished with slashing. Only being slow or offline is not.'
          ],
      ...
      },
      {
        ...
        content: '<div class="bloc-ab"><div class="bloc-a"><img src=\'/images/staking-on-ethereum/types-of-staking-part-2-9de268fd.svg\'></div><div class="bloc-b"><p><strong>Solo Staking</strong></p><p>🟡 Requires 32 ETH<br>🟡 Technical Setup<br>🟢 Decentralizes Ethereum</p><p><strong>Risks:</strong> Lost keys, <code>slashed</code> stake, offline penalties.</p></div></div><div class="bloc-ab"><div class="bloc-a"><img src=\'/images/staking-on-ethereum/types-of-staking-part-2-96f11caf.svg\'></div><div class="bloc-b"><p><strong>Staking Pools</strong></p><p>🟢 Any amount of ETH<br>🟢 Easy Setup<br>🟡 Decentralized Options</p><p><strong>Risks:</strong> Pool smart contract bugs, or lost keys.</p></div></div><div class="bloc-ab"><div class="bloc-a"><img src=\'/images/staking-on-ethereum/types-of-staking-part-2-27091ef5.svg\'></div><div class="bloc-b"><p><strong>Centralized Exchange Staking</strong></p><p>🟢 Any amount of ETH<br>🟢 Easy Setup<br>🔴 Centralizes Ethereum</p><p><strong>Risks:</strong> Exchange bankruptcy could take your funds.</p></div></div>'
      },
      {
        type: 'LEARN',
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Let’s look at an example.</p><p>Imagine a token that trades on several DEXs at once. One DEX holds a deep pool with most of the token’s <code>liquidity</code>, while another holds a shallow pool with only a small fraction of it.</p><p>If an Explorer buys the same amount of the token from each pool, the <code>price impact</code> will be higher in the shallow pool. The same trade pulls a much larger percentage of that pool’s total liquidity, so it moves the price more and costs the buyer more.</p></div><div class="bloc2"><img src=\'/images/dex-aggregators/an-example-of-how-liquidity-impacts-prices-24eb7dd7.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>DeFi continues to grow, but a problem is emerging for users: As more DEXs launch, the total amount of any individual token gets spread out. This is known as thin liquidity.</p><p>Remember the swimming pool: if the available water (<code>liquidity</code>) is split between multiple pools, the amount of water will be “thinner” in each pool compared to the total in the single original pool.</p><p>In DeFi’s early days, one or two DEXs held most of the liquidity. In 2020, new DEXs began competing for it; one rival pulled over $1B of liquidity away from Uniswap within weeks of launching. Today, liquidity is spread across hundreds of DEXs on many blockchains and <code>Layer 2</code> networks, thinning each individual pool.</p><p>Thus, any trade has a larger <code>price impact</code> than when a single DEX held most of the ecosystem’s liquidity. Without new innovations, it costs Explorers more to trade on any single DEX.</p></div><div class="bloc2"><img src=\'/images/dex-aggregators/shortcomings-of-traditional-dexs-thin-liquidity-384b90b6.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Let’s refresh how gas is calculated before seeing how DEX aggregators reduce network fees. These savings matter most on Ethereum Mainnet, where fees can be high; on <code>Layer 2</code> networks, fees are usually just cents.</p><p>Just like gas for a car, <code>gas</code> is the fuel for running blockchain code on Ethereum. The more computations you do, the more gas your code requires. Gas price is measured in very small amounts of Ether called <code>gwei</code>, like cents to a dollar. 1 gwei is 1 billionth of an ether (1 gwei = 0.000000001 ETH).</p><p>Total gas cost is based on how much gas your transaction uses and the unit price of gas at the time of use. The formula for calculating the price of a transaction is as follows:<br><em>Amount of gas used * Gas price = Total gas cost</em></p><p>As an example, let’s say gas costs are at 22 gwei per gas unit and the transaction uses 120-thousand units:<br><em>120,000 * 22 gwei = 2,640,000 gwei</em> <em><strong>or</strong></em> <em>0.00264 ETH</em></p></div><div class="bloc2"><img src=\'/images/dex-aggregators/how-gas-cost-is-calculated-on-ethereum-c7d692cd.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: '1bc1fa133e754e48ac16ce4d858011fc',
        title: 'How Aggregators Reduce Gas Costs for Users',
        content: '<div class="bloc1"><p>Trade splitting would result in more transaction fees from the extra on-chain activity, except that advanced aggregators plan for transaction fees and include them in their calculations of the trade route. They simulate trades off chain, including <code>gas</code> costs, to find <code>trade routes</code> that leave Explorers with the most value at the end of the interaction.</p><p>Some aggregators go even further. 1inch, which pioneered DEX aggregation, now also lets professional fillers compete to execute your trade and pay the gas themselves (a system called Fusion). The user often pays no gas at all.</p></div><div class="bloc2"><img src=\'/images/dex-aggregators/how-aggregators-reduce-gas-costs-for-users-aea20eff.svg\'></div>'
      },
      {
        type: 'QUIZ',
        ...
        quiz: {
          ...
          feedback: [
            ...
            'Try again! In intent systems like 1inch Fusion, fillers do cover the gas for users.'
          ],
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>There are even meta-aggregators of DEX aggregators! These platforms search through competing DEX aggregators and serve the best price quotes to users. For example, the built-in swap feature in wallets like MetaMask gathers quotes from multiple providers, including DEX aggregators like 1inch, and adds its own service fee on top.</p><p>Note: While convenient, <code>meta-aggregator</code> services can add extra costs on top of network transaction fees, increasing the overall cost for users. Explorers: make sure that your trades don’t end up more expensive than you intended.</p></div><div class="bloc2"><img src=\'/images/dex-aggregators/meta-aggregators-7609a2ce.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Some aggregators like 1inch even offer specialized <code>OTC</code> (<code>Over The Counter</code>) services that provide total protection against sandwich attacks. These optional services enable direct trading with other users, rather than routing through DeFi <code>liquidity pools</code>, giving Explorers another great way to save.</p><p>CoW Swap takes a different approach: users sign a trade request (an <code>intent</code>), and professional <code>solvers</code> compete in <code>batch auctions</code> to fill it at the best price. Solvers can even match two users directly, so trades are protected from sandwich attacks by default.</p></div><div class="bloc2"><img src=\'/images/dex-aggregators/more-protection-from-sandwiches-otc-trades-3da1b5df.svg\'></div>'
      },
      {
        type: 'QUIZ',
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Allo Protocol is a set of smart contracts designed for democratic onchain capital allocation and distribution, developed to empower the Grants Stack.</p><p>Allo’s simple, generalized architecture allows it to be <strong>easily customized</strong> for a wide range of use cases. Its power lies in its ability to <strong>deepen impact</strong> by allocating capital at scale. There are three key components to the protocol:</p><ol><li><strong>Tokens:</strong> funding sources sending tokens into a pool.</li><li><strong>Registry:</strong> structuring data of possible participants that are eligible for distribution of tokens.</li><li><strong>Strategy:</strong> designating how tokens will be allocated and distributed to recipients.</li></ol><p>💡  An easy way to remember what Allo Protocol is or does, is that it’s short for <em>Capital Allocation Protocol</em>. For a deeper understanding of what people can create using Allo, checkout the design space-focused <a href=\'https://www.gitcoin.co/rainbowpaper\'>rainbowpaper</a>.</p></div><div class="bloc2"><img src=\'/images/gitcoin-2.0-essentials/expanding-beyond-evm-with-allo-protocol-c8a108f7.png\'></div>'
      },
      {
        type: 'LEARN',
    ...
    slides: [
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'This is true, but it isn’t the only answer.',
            'This is true, but it isn’t the only answer.',
            'This is true, but it isn’t the only answer.',
            'Correct! Onchain governance protects the voting process through multiple means.'
          ],
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Education can benefit everyone, and one person’s use doesn’t reduce its availability.',
            'The internet can benefit everyone, and one person’s use doesn’t reduce its availability.',
            'Ethereum can benefit everyone, and — with Layer 2s — one person’s use doesn’t reduce its availability.',
            'Correct. While CEXs provide community benefits, they are private businesses.'
          ],
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Try again!',
            'Correct! The Foundation will eventually dissolve, and the Collective will continue the mission.'
          ],
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Try again! Rewarding all projects regardless of their mission is not Optimism’s approach.',
            'Try again! Use of blockchain technology alone doesn’t affect economic models.',
            'Correct! The network allocates a portion of transaction fees towards funding public goods.',
            'Try again! Only one of these is true.'
          ],
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'Try again! Both houses have veto powers.',
            'Correct! The Citizens’ House allocates public goods funding.',
            'Try again! Both houses maintain decentralization.',
            'Try again!'
          ],
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            ...
            'This is true, but it isn’t the only answer.',
            'This is true, but it isn’t the only answer.',
            'Correct! The Token House has a diverse set of responsibilities in protecting the network.'
          ],
      ...
      },
      {
        ...
        quiz: {
          ...
          feedback: [
            'This is true, but it isn’t the only answer.',
            'This is true, but it isn’t the only answer.',
            'Correct! This house diversifies its own perspective, and balances Token House perspective.'
          ],
