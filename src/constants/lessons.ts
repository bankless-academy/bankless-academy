...
const LESSONS: LessonType[] = [
  ...
  {
    kudosImageLink: null,
    lessonImageLink: '/lesson/how-to-fund-a-wallet-on-l2/lesson-71b79973.png',
    socialImageLink: '/lesson/how-to-fund-a-wallet-on-l2/social-adb1717b.png',
    learningActions: '',
    marketingDescription: 'Learn how to fund your wallet on L2 via CEXs, third-party onramps or bridges.',
    kudosId: null,
    duration: 5,
    learnings: '',
    difficulty: undefined,
    description: 'Learn how to fund your wallet on L2 via CEXs, third-party onramps or bridges.',
    name: 'How to Fund a Wallet on L2',
    ...
    mirrorLink: 'https://mirror.xyz/hirokennelly.eth/EkZPfxjbqa_tbixookC8RAZVg1sKqk6oygsnHK4j5dM',
    isArticle: true,
    notionId: '549533d73275476d905dc2c34c4c2b5c',
    slug: 'how-to-fund-a-wallet-on-l2',
    articleContent: 'If you’re new to crypto, all the talk about the importance of Layer 2 (or L2) must seem a bit odd, confusing really. In contrast to Layer 1, which often refers to Ethereum mainnet, Layer 2 is a term for a specific type of Ethereum [scaling solution](https://ethereum.org/en/developers/docs/scaling/) that enables users to inherit the security of Ethereum but enjoy low transaction fees and fast block inclusion times. If you’ve ever heard of [Optimism](https://www.optimism.io/), [Arbitrum](https://portal.arbitrum.one/), or [Polygon](https://polygon.technology/) (which is really a side chain, but let’s not worry about that here), those are Layer 2 scaling solutions.\n\nThe cost to transact on Ethereum hasn’t been this cheap in years, but it’s hard to forget that during the height of the bull market, it could cost the equivalent of 80 USD in Ethereum network fees – what we call [Gwei](https://cryptodefinitions.com/dictionary/gwei/) or gas, to swap tokens, and much more to mint NFTs or provide liquidity to DEXs on mainnet. These days, during the depths of crypto winter, most transactions on Ethereum mainnet cost a few dollars, and it takes an FTX debacle or a beyond-hyped NFT drop to really spike transaction fees.\n\nEven though mainnet is not as cost prohibitive on a per-transaction basis as it used to be, many of the most innovative protocols are building on L2s, and at some point the Ethereum network will become congested again —  read expensive — forcing people to migrate to Ethereum scaling solutions.\n\nUnless you’ve been in the ecosystem for a while, it’s not entirely intuitive how to start using Layer 2s. But there is a clear place to begin your journey into Ethereum scaling solutions: funding your wallet on Layer 2.\n\nThere are three main ways to fund an L2 wallet: moving your crypto from a centralized exchange straight to a Layer 2 network, using a third party crypto payment service to fund an L2 wallet, or sending your digital assets from mainnet to L2.\n\n## Funding From CEXs\n\nFunding your L2 wallet directly from a centralized exchange is perhaps the simplest way to fund your wallet, particularly if you haven’t moved on to the [self-custody](https://banklesspublishing.com/the-importance-of-self-custody/) phase of your crypto journey. Most major CEXs offer users this option, although it isn’t always clear to the user.\n\nOn Coinbase, for example, users can send their funds directly to Optimism or Polygon in just a few steps:\n\n![Send it straight away!](https://images.mirror-media.xyz/publication-images/G8ZJLULiYAaIW7SyRYqUF.png?height=300&width=700)\n\n1. Purchase or hold ETH on the CEX\n\n2. Click or tap ‘Send & Receive’\n\n3. Choose ETH as the asset, and the amount you wish to send to an L2\n\n4. Enter your address where you want to receive the funds\n\n5. Change the Network from Ethereum to Optimism\n\n6. Click of tap ‘Send Now’\n\nMost major exchanges offer users the ability to send their crypto directly to an L2. Binance supports Optimism and Arbitrum, for example. On whatever centralized exchange you convert fiat to crypto, check to see whether it offers support for direct-to-L2 services.\n\n## 3rd Party Onramps\n\nAnother simple way to fund your L2 wallet is to take advantage of direct-to-L2 services offered by many 3rd party crypto payment companies. [MoonPay](https://www.moonpay.com/), [Ramp](https://ramp.network/), and [Transak](https://transak.com/) are three of the most popular options to fund crypto wallets without having to use a centralized exchange.\n\nLike most exchanges, these third party onramps will require you to provide Know-Your-Customer information. However, once you get past those basic hurdles, these payment options are an easy way to buy crypto across the ecosystem and transfer it to your scaling solution of choice.\n\nFor MoonPay, the steps are:\n\n![It won\'t get you to the moon, but it will launch you to L2](https://images.mirror-media.xyz/publication-images/wnx7jkOYLpznB87CGXpNv.png?height=300&width=700)\n\n1. Select ‘Buy crypto’\n\n2. Select the fiat denomination of your choice\n\n3. Select an asset, in this case ETH.\n\n4. You will see different networks on which you can purchase ETH - choose the Layer 2 of your choice\n\n5. Click continue and enter your wallet address\n\n6. Confirm the information is correct and click or tap ‘Pay’\n\nAs with CEXs, most major third party payment onramps provide direct-to-L2 functionality. Take advantage of these technological advancements today to save on transaction fees tomorrow!\n\n## Funding From Bridges\n\nIf you already have funds on mainnet, by far the easiest way to get your crypto on to an L2 is to use a bridging protocol. Bridges are the name we’ve given to protocols designed to help us move our funds around the cryptoverse, and there are a number of bridges designed to move crypto from Ethereum mainnet to Layer 2s.\n\n### Native Bridges\n\nNative bridges are those designed by the Layer 2 protocols themselves. For true Layer 2 scaling solutions like Arbitrum and Optimism, it takes about 30 minutes to move funds onto the L2, but a week to move that crypto back over to mainnet. The [Optimism Bridge](https://app.optimism.io/bridge/deposit) and the [Arbitrum Bridge](https://bridge.arbitrum.io/) take longer to transfer assets and settle transactions because of the way the scaling solution is designed.\n\n### 3rd Party Bridges\n\nBecause no one likes to wait, a number of 3rd party bridging services exist to help us move our funds instantly to and from L2s. Among the most popular options are [Hop Protocol](https://app.hop.exchange/#/send?token=ETH) and [Across Protocol](https://across.to/bridge), and using these services is as simple as moving funds off of a centralized exchange. To use Across, for example, all you need to do is:\n\n![Bridging it is the best way to move funds from mainnet](https://images.mirror-media.xyz/publication-images/jAycTNKM9hpshRg-NxwPn.png?height=300&width=700)\n\n1. Go to the Across Protocol bridge\n\n2. If you want to bridge funds to an L2, select Ethereum in ‘From’\n\n3. Next, select your L2 solution in ‘To’\n\n4. Choose your asset and the amount (Pro Tip - only bridge a blockchain’s native asset, in this case ETH)\n\n5. Hit ‘Send’ and wait a few minutes for your funds to appear!\n\nMoving funds from mainnet to L2 is really that simple - and nearly all bridges work the same way. Select a blockchain to send funds from and your destination, pick an asset and amount, and across the blockchain crevice you go.\n\n## The Road to L2\n\nLayer 2s offer users of all experience levels the opportunity to experiment with decentralized finance in a way that is often prohibitive on mainent. Because it costs mere pennies to transact on these networks, it’s a great place to become familiar with the basic building blocks of decentralized finance, from swaps and liquidity pools to yield farms and degen leverage plays.\n\nUsing a CEX or a bridge to move funds to L2 is a necessary step in your journey from crypto novice to crypto competent. Remember, to see your funds in your wallet, you may need to add the network in your wallet settings. If you just want to check that the funds made it safely to your L2 wallet, you can also check [Etherscan](https://etherscan.io/) or go to a DEX, like [Uniswap](https://uniswap.org/), and select the L2 network and the asset to see your balance.\n\nRegardless, as you scale up your skills, you’ll need to figure out how to scale down your transaction fees. Learning how to fund an L2 wallet is the first step, but the next steps on your crypto journey are up to you. Have fun, and don’t forget your [towel](https://hitchhikers.fandom.com/wiki/Towel).\n\n\n---\n\n***[Hiro Kennelly](https://twitter.com/HiroKennelly)**** is a writer, editor, and coordinator at BanklessDAO and the Editor-in-Chief at Good Morning News. He is also helping to build a grants-focused organization at DAOpunks.*'
  },
  {
