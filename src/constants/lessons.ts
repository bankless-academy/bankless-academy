  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Recuerda, los datos de un <code>bloque</code> son simplemente un grupo de transacciones juntas. Al examinar un solo bloque, vemos una lista de transacciones y algunos datos sobre quién creó el bloque.</p><p>Siguiendo nuestro ejemplo anterior, cuando discutimos sobre el libro mayor de la blockchain, ambas transacciones podrían estar agrupadas en un solo bloque o distribuidas en varios bloques a lo largo del tiempo. Pero sin importar en qué bloque se incluyeran, eventualmente se agregarán todas al libro mayor general de la blockchain.</p><ul><li>Alice envía 5 ETH a Bob.</li><li>Bob envía 2 ETH a Charlie.</li></ul><p>Recuerda que cada bloque también debe hacer referencia al <code>hash de bloque</code> del <em>bloque anterior</em> para enlazar la blockchain.</p></div><div class="bloc2"><img src=\'/lesson/conceptos-basicos-de-blockchain/interior-de-un-bloque-b9ecc7c3.svg\'></div>'
      },
      {
        type: 'QUIZ',
