...
const LESSONS: LessonType[] = [
  ...
  {
    badgeImageLink: null,
    lessonImageLink: '/images/understanding-ethereum-token-standards/lesson-71b79973.png',
    socialImageLink: '/images/understanding-ethereum-token-standards/social-adb1717b.png',
    learningActions: '',
