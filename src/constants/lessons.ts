...
const LESSONS: LessonType[] = [
  ...
  },
  {
    ...
    imageLinks: [
      ...
      '/lesson/web3-security/social-media-safety-2-3e6a2b56.png'
    ],
    slides: [
      {
        type: 'LEARN',
