...
const LESSONS: LessonType[] = [
  ...
  },
  {
    ...
    imageLinks: [
      ...
      '/lesson/decentralized-exchanges/automated-market-makers-a866032c.svg',
      '/lesson/decentralized-exchanges/token-swaps-057a63e7.svg',
      '/lesson/decentralized-exchanges/token-swaps-continued-391dd8c7.svg',
    ...
    slides: [
      {
        ...
        content: '<div class="bloc1"><p>Decentralized Exchanges (DEXs) are on-chain marketplaces that enable Explorers to securely exchange cryptocurrency with other users while maintaining self-custody of their wallet funds. These peer-to-peer trades are facilitated using publicly accessible smart contracts that connect users with large communal vaults of tokens. These vaults are called liquidity pools. DEXs can be found on almost all blockchains, and are present on both Ethereum Layer 1 and 2.</p><p>Exchanging tokens is an essential part of using <code>DeFi</code>. In DeFi you’ll find a greater range of token variety and utility than on a <code>CEX</code>. Some users buy tokens to access on-chain products and services. Others purchase tokens as a short or long term investment. Some tokens grant holders voting power used to determine project direction — much like holding shares in a traditional corporation! Regardless of your motivation, you’ll be visiting DEXs on a regular basis in DeFi.</p><p>Let\'s learn how they work and how they can best serve you.</p></div><div class="bloc2"><img src=\'/lesson/decentralized-exchanges/what-is-a-decentralized-exchange-8ce458f2.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: 'f84de8f77ba64d95ae97b0b5bab8f65c',
        title: 'Centralized and Decentralized Exchanges',
        content: '<div class="bloc1"><p>Let’s cover the differences between the technology used for a Centralized Exchange (like Coinbase, Binance, Kraken) and that of a Decentralized Exchange (like Uniswap, PancakeSwap).</p><p>Centralized Exchanges (<code>CEXs</code>) allow users to trade and invest in cryptocurrency, outside the blockchain ecosystem itself. As your account is on the CEX itself, your private keys and funds are in their custody, and you’re subject to their management, rules, and risks.</p><p>Use of Decentralized Exchanges (<code>DEXs</code>) to manage cryptocurrency is the original intended purpose of blockchains. The peer-to-peer model allows you to act as both the consumer and the provider — accessing financial opportunities previously available only to the financial class. The system is both transparent and censorship-resistant, creating equal opportunity while protecting users from hackers, the state, or any participant seeking to gain an unfair advantage.</p></div><div class="bloc2"><img src=\'/lesson/decentralized-exchanges/centralized-and-decentralized-exchanges-ad25050a.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>DEXs are a type of <code>dApp</code> — a decentralized application running on a blockchain. For an internet application to be considered fully ‘decentralized’ it needs to facilitate any user’s chosen interaction with the dApp without the need for oversight or a third party.</p><p>dApp services are facilitated using smart contracts, lines of code that take a user’s on-chain action and return a predictable on-chain response. The Ethereum Foundation compares smart contracts to vending machines: The user inputs the number corresponding to the item they’d like to receive, plus the appropriate amount of money, and they receive an expected output — their snack — without the need for another person to facilitate the transaction.</p><p>DEX dApps handle a variety of commands, like swapping, voting, or adding and removing liquidity.</p></div><div class="bloc2"><img src=\'/lesson/decentralized-exchanges/decentralized-applications-ee3321de.svg\'></div>'
      },
      {
        type: 'LEARN',
