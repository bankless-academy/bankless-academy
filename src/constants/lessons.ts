  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        title: 'How it Works',
        content: '<div class="bloc1"><p>Let’s bring it all together by looking under the hood. As a <code>peer-to-peer</code> network, Ethereum is made up of computers spread across the world. These devices have been volunteered to run the network by their owners. Using automated software, these <code>validators</code> process transactions, check the results of others to negate fraud, and generate <code>ether</code> rewards for their owners.</p><p>Your decentralized transaction is processed by validators on the network:</p><ol><li>Your ETH transaction is submitted to the Ethereum Network.</li><li>A validator checks your transaction for errors. Other validators double-check their results.</li><li>If approved, your transaction is added to the network ledger, the <code>Ethereum blockchain</code>.</li><li>The recipient receives your transferred ETH in their wallet.</li></ol><p>This transaction process is very similar when interacting with dApps, with a few added steps and connections. We’ll save the details for a future lesson.</p></div><div class="bloc2"><iframe allowfullscreen class=\'animation\' src=\'https://app.banklessacademy.com/animation/ethereum\'></iframe></div>'
      },
      {
        type: 'QUIZ',
