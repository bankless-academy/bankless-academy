...
const LESSONS: LessonType[] = [
  {
    badgeImageLink: '/lesson/images/wallet-basics/badge-75d8aa76.png',
    ...
    slug: 'wallet-basics',
    imageLinks: [
      '/lesson/images/wallet-basics/wallet-intro-7b45d75e.png',
      '/lesson/images/wallet-basics/wallet-definition-e8f8f9a8.svg',
      '/lesson/images/wallet-basics/recovery-phrase-c2d8fa26.svg',
      '/lesson/images/wallet-basics/public-key-b6387071.svg',
      '/lesson/images/wallet-basics/private-key-ca271641.svg',
      '/lesson/images/wallet-basics/custodial-wallet-29ed2b65.svg',
      '/lesson/images/wallet-basics/non-custodial-wallet-aee2708b.svg',
      '/lesson/images/wallet-basics/hot-wallet-1d444d7c.svg',
      '/lesson/images/wallet-basics/cold-wallet-59646edb.svg',
      '/lesson/images/wallet-basics/metamask-wallet-521de184.svg'
    ],
    slides: [
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        title: 'Public Key',
        content: '<div class="bloc1"><p>You just learned how your <code>recovery phrase</code> relates to a <code>public key</code> and <code>private key</code>.</p><p>Note that a wallet can contain multiple accounts, and <em>each account</em> has a unique pair of public and private keys.</p><p>Think of a public key like your home address. It is public, anyone can see it, and it identifies the location to use to send crypto assets to you.</p></div><div class="bloc2"><img src=\'/lesson/images/wallet-basics/public-key-b6387071.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: 'a6dab3c7c04949baa0c5448f57c91cfe',
        title: 'Private Key',
        content: '<div class="bloc1"><p>If your <code>public key</code> is like your home address, then your <code>private key</code> is like your house key.</p><p>It\'s called private because <em>only you</em> should have access to it.</p><p>The private key unlocks access to your wallet and your crypto assets, allowing you to send them to other wallet addresses.</p></div><div class="bloc2"><img src=\'/lesson/images/wallet-basics/private-key-ca271641.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        title: 'Hot Wallet',
        content: '<div class="bloc1"><p>There are two major types of <code>non-custodial wallets</code>: software wallets (also called <code>hot wallets</code>) and hardware wallets (also called <code>cold wallets</code>)</p><p>A software wallet is an app or browser extension that remains connected to the internet.</p><ul><li>PROS 👍: It is usually free, simple to set up, and easy to use.</li><li>CONS 👎: Because it is software connected to the internet, it\'s potentially a target for hackers.</li></ul></div><div class="bloc2"><img src=\'/lesson/images/wallet-basics/hot-wallet-1d444d7c.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: '2db8d9f5695b4b46aa35bef2e17bcb75',
        title: 'Cold Wallet',
        content: '<div class="bloc1"><p>A <code>cold wallet</code>, or hardware wallet, is only connected to the internet when you physically connect it to a computer or device.</p><ul><li>PROS 👍: It is more secure from threats like hacking.</li><li>CONS 👎: It is not free, not ideal for quick transactions, and can be cumbersome to use.</li></ul></div><div class="bloc2"><img src=\'/lesson/images/wallet-basics/cold-wallet-59646edb.svg\'></div>'
      },
      {
        type: 'QUIZ',
  ...
  {
    badgeImageLink: '/lesson/images/blockchain-basics/badge-b0048cdb.png',
    ...
    imageLinks: [
      '/lesson/images/blockchain-basics/introduction-6d0b6137.svg',
      '/lesson/images/blockchain-basics/blockchain-structure-346dae14.svg',
      '/lesson/images/blockchain-basics/examining-the-ledger-74e5f072.svg',
      '/lesson/images/blockchain-basics/transactions-on-the-ledger-f4f9d470.svg',
      '/lesson/images/blockchain-basics/block-anatomy-8ba3bea2.svg',
      '/lesson/images/blockchain-basics/inside-a-block-b11c74ce.svg',
      '/lesson/images/blockchain-basics/individual-transactions-2f6bf118.svg',
      '/lesson/images/blockchain-basics/user-addresses-e9456d37.svg'
    ],
    slides: [
      {
        type: 'LEARN',
  ...
  },
  {
    ...
    slug: 'web3-security',
    imageLinks: [
      '/lesson/images/web3-security/money-in-web2-78779f3c.svg',
      '/lesson/images/web3-security/money-in-web3--832997fe.svg',
      '/lesson/images/web3-security/two-factor-authentication-75e29563.svg',
      '/lesson/images/web3-security/social-engineering-scams-5750ad84.svg',
      '/lesson/images/web3-security/social-media-safety-fbe97b9e.svg',
      '/lesson/images/web3-security/social-media-best-practices-0776e310.svg',
      '/lesson/images/web3-security/scam-tokens-cbab390e.svg',
      '/lesson/images/web3-security/hardware-wallets-191cacd1.svg',
      '/lesson/images/web3-security/wallet-strategies-857fd09c.svg'
    ],
    slides: [
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>In both web2 and web3, scammers use <code>phishing</code> tactics to trick people into giving up their passwords and seed phrases. Often they’ll pretend to be product support staff offering help, “Hello this is Metamask support”, or pretend to be an admin of a community, “New NFT mint, exclusive for our community”.</p><p>They use <code>social engineering</code> to pressure people. Examples include:</p><ul><li>“Time is running out!” - making you feel rushed.</li><li>“Congratulations you won our giveaway!” - making things feel exclusive.</li><li>”Get early access to our pre-mint!” - generating <code>FOMO</code> in the person being scammed.</li></ul></div><div class="bloc2"><img src=\'/lesson/images/web3-security/social-engineering-scams-5750ad84.svg\'></div>'
      },
      {
        type: 'LEARN',
  ...
  {
    badgeImageLink: '/lesson/images/layer-1-blockchains/badge-66fa6447.png',
    ...
    imageLinks: [
      '/lesson/images/layer-1-blockchains/introduction-e0da8469.svg',
      '/lesson/images/layer-1-blockchains/blockchain-trilemma-31329f66.svg',
      '/lesson/images/layer-1-blockchains/security-and-consensus-5e1f03b6.svg',
      '/lesson/images/layer-1-blockchains/security-and-attacks-7d35acf6.svg',
      '/lesson/images/layer-1-blockchains/scalability-throughput-4b140ad0.svg',
      '/lesson/images/layer-1-blockchains/scalability-finality-161f7e2b.svg',
      '/lesson/images/layer-1-blockchains/decentralization-distributes-power-829f91a2.svg',
      '/lesson/images/layer-1-blockchains/is-it-decentralized-4b5bf857.svg',
      '/lesson/images/layer-1-blockchains/some-examples-523b9b96.svg',
      '/lesson/images/layer-1-blockchains/so-what-can-be-done-50592b46.svg',
      '/lesson/images/layer-1-blockchains/the-future-of-ethereum-2b64fd6b.svg'
    ],
    slides: [
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Security is the most foundational requirement for a public blockchain. Computers within a network (such as a blockchain network) must agree on what transactions have truly happened to work together; this agreement is called <code>consensus</code>. A blockchain is secure if attackers cannot disrupt the network from agreeing on that truth. Consensus algorithms are designed to resist these attacks.</p><p>Chains like Bitcoin that use <code>Proof of Work</code> consensus prevent fraud by making their consensus algorithm highly competitive; each block producer races to solve a math problem. The first to do so wins the right to create the next block and receives the monetary <code>block reward</code> that comes with it. Fraud would require massive investments in computing power and energy, so an attacker would likely spend more than they’d gain. </p></div><div class="bloc2"><img src=\'/lesson/images/layer-1-blockchains/security-and-consensus-5e1f03b6.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>One potential form of attack on blockchain consensus is a <code>51% attack</code>; an attacker needs to have 51% or more of the consensus power on a network to commit fraud by creating falsified transactions. This means 51% of the computing power solving math problems in Proof of Work consensus and 51% of the <code>stake</code> in Proof of Stake consensus. Again, fraud would require a massive capital investment to acquire a stake in the network, which will be destroyed if found to be creating false transactions; an attacker would likely spend more than they’d gain.</p><p>In <code>Proof of Stake</code> consensus, the block producer isn’t chosen through competition but is randomly assigned instead. Like with Proof of Work, the consensus algorithm ensures that any single entity cannot regularly “win” the right to create a new <code>block</code>. </p></div><div class="bloc2"><img src=\'/lesson/images/layer-1-blockchains/security-and-attacks-7d35acf6.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Previously known as the Ethereum 2.0 upgrade, the Ethereum network is evolving its scalability without sacrificing the other aspects of the trilemma. These changes include the merge to <code>Proof of Stake</code> consensus, Layer 2s going live, <code>sharding</code> of the main chain, and an overall reduction of energy usage. <strong>All of these changes together will mean a faster, more environmentally-friendly, and cheaper Ethereum while still maintaining security and decentralization as core tenets.</strong> The Ethereum Foundation has an excellent webpage on coming <a href=\'https://ethereum.org/en/upgrades/\'>upgrades to Ethereum</a>.</p><p>These things take time; meanwhile, many <code>Layer 2</code> protocols are building on top of Ethereum to help meet user demand in the short term without requiring updates to the Ethereum protocol itself. These Layer 2 protocols rely on Layer 1 Ethereum to provide decentralized security while they provide scalability; the diversity of Layer 2s makes a decentralized ecosystem! Ethereum scaling projects include protocols like Optimistic Ethereum, Polygon, and others.</p></div><div class="bloc2"><img src=\'/lesson/images/layer-1-blockchains/the-future-of-ethereum-2b64fd6b.svg\'></div>'
      },
      {
        type: 'QUIZ',
  ...
  {
    badgeImageLink: '/lesson/images/layer-2-blockchains/badge-761ee1a2.png',
    lessonImageLink: '/lesson/images/layer-2-blockchains/lesson-a7d46fcd.png',
    ...
    socialImageLink: '/lesson/images/layer-2-blockchains/social-af4d2034.jpg',
    learningActions: '',
    ...
    sponsorLogo: '/lesson/images/layer-2-blockchains/sponsor-90c31693.png',
    hasCollectible: true,
    notionId: '340eb401ab824dea8f85aace1aaf69c1',
    slug: 'layer-2-blockchains',
    imageLinks: [
      '/lesson/images/layer-2-blockchains/introduction-0d584167.svg',
      '/lesson/images/layer-2-blockchains/payment-channels-5e29dfd3.svg',
      '/lesson/images/layer-2-blockchains/bridging-layer-1-and-layer-2-8268ff20.svg',
      '/lesson/images/layer-2-blockchains/sidechains-406fe8d1.svg',
      '/lesson/images/layer-2-blockchains/rollups-ea8672d0.svg',
      '/lesson/images/layer-2-blockchains/optimistic-rollups-75b31999.svg',
      '/lesson/images/layer-2-blockchains/zk-rollups-bc7c293e.svg',
      '/lesson/images/layer-2-blockchains/cross-chain-dapp-compatibility-eeb2b414.svg',
      '/lesson/images/layer-2-blockchains/start-your-layer-2-journey-with-optimism--7999722b.svg'
    ],
    slides: [
      {
        type: 'LEARN',
  ...
  {
    badgeImageLink: null,
    lessonImageLink: '/lesson/images/managing-token-allowances/lesson-71b79973.png',
    socialImageLink: '/lesson/images/managing-token-allowances/social-adb1717b.png',
    learningActions: '',
  ...
  {
    badgeImageLink: '/lesson/images/intro-to-defi/badge-b4dab2d4.png',
    ...
    slug: 'intro-to-defi',
    imageLinks: [
      '/lesson/images/intro-to-defi/defi-defined-46782447.svg',
      '/lesson/images/intro-to-defi/earning-yield-c5f123f8.svg',
      '/lesson/images/intro-to-defi/what-you-can-do-with-defi-9b17cf2e.svg',
      '/lesson/images/intro-to-defi/investing-d99a6d1f.svg',
      '/lesson/images/intro-to-defi/trading-8cd72977.svg',
      '/lesson/images/intro-to-defi/lending-borrowing-4fb1c7c3.svg',
      '/lesson/images/intro-to-defi/staking-b4b4319d.svg',
      '/lesson/images/intro-to-defi/defi-downsides-51dd6225.svg',
      '/lesson/images/intro-to-defi/defi-downsides-3a6ce496.svg',
      '/lesson/images/intro-to-defi/defi-downsides-83a9391f.svg'
    ],
    slides: [
      {
        type: 'LEARN',
        ...
        title: 'DeFi Defined',
        content: '<div class="bloc1"><p>DeFi—short for <code>decentralized</code> finance—refers to the fast-growing ecosystem of financial products, protocols, and applications that operate on public <code>blockchain</code> networks.</p><p>DeFi is rapidly transforming the world of finance with a range of new tools for putting crypto assets to work. It offers opportunities beyond simply buying crypto on a centralized exchange. It allows anyone and everyone to build a decentralized, Bankless lifestyle.</p></div><div class="bloc2"><img src=\'/lesson/images/intro-to-defi/defi-defined-46782447.svg\'></div>'
      },
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>The most common <code>DeFi</code> transaction is to purchase some cryptocurrency with the expectation that it will be worth more in the future. This is known as investing.</p><p>HODL is a term used for keeping crypto assets for a long time. Depending on who you ask, the HODL meme either comes from a typo of HOLD or it stands for <strong>H</strong>old <strong>O</strong>n for <strong>D</strong>ear <strong>L</strong>ife.</p><p>DeFi allows early access to coins and tokens to find and invest in, before they are listed on centralized exchanges (CEX).</p></div><div class="bloc2"><img src=\'/lesson/images/intro-to-defi/investing-d99a6d1f.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc-ab"><div class="bloc-a"><img src=\'/lesson/images/intro-to-defi/defi-downsides-51dd6225.svg\'></div><div class="bloc-b"><p><strong>Hackers</strong></p><p>Where there is money and technology, there are people looking for ways to hack the system and take advantage of poor security measures.</p></div></div><div class="bloc-ab"><div class="bloc-a"><img src=\'/lesson/images/intro-to-defi/defi-downsides-3a6ce496.svg\'></div><div class="bloc-b"><p><strong>Risk</strong></p><p>DeFi, like blockchain technology, runs on code. If there’s an error or loophole in the code, it can be exploited.</p></div></div><div class="bloc-ab"><div class="bloc-a"><img src=\'/lesson/images/intro-to-defi/defi-downsides-83a9391f.svg\'></div><div class="bloc-b"><p><strong>No recourse</strong></p><p>Being decentralized also means there are no companies or government agencies that you can appeal to for help if something goes wrong.</p></div></div>'
      },
      {
        type: 'QUIZ',
  ...
  },
  {
    ...
    sponsorLogo: '/lesson/images/decentralized-exchanges/sponsor-f4fee676.png',
    ...
    nftGatingImageLink: '/lesson/images/decentralized-exchanges/nft-1809907e.png',
    ...
    imageLinks: [
      '/lesson/images/decentralized-exchanges/what-is-a-decentralized-exchange-8ce458f2.svg',
      '/lesson/images/decentralized-exchanges/centralized-and-decentralized-exchanges-ad25050a.svg',
      '/lesson/images/decentralized-exchanges/decentralized-applications-ee3321de.svg',
      '/lesson/images/decentralized-exchanges/decentralized-applications-continued-c1a4b467.svg',
      '/lesson/images/decentralized-exchanges/automated-market-makers-018428cb.svg',
      '/lesson/images/decentralized-exchanges/token-swaps-f1c9f932.svg',
      '/lesson/images/decentralized-exchanges/token-swaps-continued-0af4afc8.svg',
      '/lesson/images/decentralized-exchanges/what-is-liquidity-99bb4930.svg',
      '/lesson/images/decentralized-exchanges/liquidity-providers-cd2b7547.svg',
      '/lesson/images/decentralized-exchanges/dex-best-practices-4a9ebcd4.svg'
    ],
    slides: [
      {
        type: 'LEARN',
  ...
  {
    badgeImageLink: '/lesson/images/dex-aggregators/badge-ddb9db8b.png',
    ...
    endOfLessonText: undefined,
    sponsorName: '1inch',
    sponsorLogo: '/lesson/images/dex-aggregators/sponsor-91f0dd82.png',
    notionId: '42578b8813114832b8930cf59f6125af',
    slug: 'dex-aggregators',
    imageLinks: [
      '/lesson/images/dex-aggregators/introduction-ba453b68.svg',
      '/lesson/images/dex-aggregators/an-example-of-how-liquidity-impacts-prices-915b3d84.svg',
      '/lesson/images/dex-aggregators/shortcomings-of-traditional-dexs-thin-liquidity-c9e0b695.svg',
      '/lesson/images/dex-aggregators/recombining-liquidity-with-dex-aggregators-f01777dd.svg',
      '/lesson/images/dex-aggregators/how-gas-cost-is-calculated-on-ethereum-c34efe86.svg',
      '/lesson/images/dex-aggregators/how-aggregators-reduce-gas-costs-for-users-28d6f207.svg',
      '/lesson/images/dex-aggregators/meta-aggregators-100793fd.svg',
      '/lesson/images/dex-aggregators/avoiding-sandwich-attacks-75f6ae82.svg',
      '/lesson/images/dex-aggregators/more-protection-from-sandwiches-otc-trades-04ef66c9.svg'
    ],
    slides: [
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Let’s look at an example. </p><p>The BanklessDAO token (BANK) has a liquidity amount of ~30 million BANK on Uniswap, but only ~4.5 million BANK on SushiSwap. Uniswap has over 6x the BANK liquidity of SushiSwap.</p><p>If an Explorer was to purchase 10,000 BANK from each pool, they would find that the <code>price impact</code> of their trade would result in a higher trade price in the SushiSwap pool — because their trade has pulled a larger percentage of the pool’s total liquidity.</p></div><div class="bloc2"><img src=\'/lesson/images/dex-aggregators/an-example-of-how-liquidity-impacts-prices-915b3d84.svg\'></div>'
      },
      {
        type: 'QUIZ',
  ...
  },
  {
    ...
    imageLinks: [
      '/lesson/images/optimism-governance/old-problems-new-tools-1662dfbf.svg',
      '/lesson/images/optimism-governance/network-governance-161475d9.svg',
      '/lesson/images/optimism-governance/the-optimism-network-99428791.svg',
      '/lesson/images/optimism-governance/progressive-decentralization-5f487c1b.svg',
      '/lesson/images/optimism-governance/a-new-economy-41fc0d66.svg',
      '/lesson/images/optimism-governance/incentivizing-the-public-goods-economy-123cdbec.svg',
      '/lesson/images/optimism-governance/ethers-phoenix-023606f1.svg',
      '/lesson/images/optimism-governance/introducing-the-governing-houses-09299832.svg',
      '/lesson/images/optimism-governance/the-token-house-ffa12a64.svg',
      '/lesson/images/optimism-governance/a-note-on-token-distribution-45e8fc75.svg',
      '/lesson/images/optimism-governance/the-citizens-house-0724be8f.svg',
      '/lesson/images/optimism-governance/governance-seasons-4ebc291c.svg',
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p><code>DAOs</code> like the <code>Optimism Collective</code> are at the frontier of exploring such coordination systems. </p><p>In this lesson, we will explore how Optimism is pioneering the DAO vision. We will learn about their mission, and how they’re building new coordination frameworks for humanity.</p><p>Our quest will focus on claiming our first voting rights, so we’ll be ready to help build the future of Ethereum and human coordination!</p></div><div class="bloc2"><img src=\'/lesson/images/optimism-governance/the-optimism-network-99428791.svg\'></div>'
      },
      {
        type: 'LEARN',
  ...
  {
    badgeImageLink: null,
    lessonImageLink: '/lesson/images/how-to-delegate-on-optimism/lesson-cbf56286.png',
    learningActions: '',
    ...
    articleContent: '## Key Takeaways\n\n> * There are a number of ways to fund your wallet on an Ethereum scaling solution like Optimism, Arbitrum, or Polygon.\n>\n> * Centralized exchanges often provide a direct Layer 2 onramp.\n>\n> * Third-party payment apps enable users to fund a wallet on Layer 2 from a bank account or a debit or credit card.\n>\n> * Protocol bridges let users send funds from Ethereum Mainnet to Layer 2.\n\nIf you’re new to crypto, all the talk about the importance of `Layer 2` (or L2) must seem a bit odd, confusing really. In contrast to [Layer 1](https://app.banklessacademy.com/lessons/layer-1-blockchains), which often refers to [Ethereum Mainnet](https://ethereum.org/), Layer 2 is a term for a specific type of Ethereum scaling solution that enables users to inherit the security of Ethereum but enjoy low transaction fees and fast `block` inclusion times. If you’ve ever heard of [Optimism](https://www.optimism.io/), [Arbitrum](https://arbitrum.io/), or [Polygon](https://polygon.technology/) (which is really a side chain, but let’s not worry about that here), those are Layer 2 scaling solutions.\n\nWhen the Ethereum network is busy, it can cost the equivalent of 80 USD in transaction fees — known as `gwei` or gas — to swap tokens, and much more to mint NFTs or provide `liquidity` to a `decentralized exchange` (DEX) on Mainnet. When network activity is low, most transactions on Ethereum Mainnet still cost a few dollars, and it takes an [FTX-level debacle](https://www.investopedia.com/ftx-exchange-5200842) or a [beyond-hyped NFT drop](https://dappradar.com/blog/yuga-labs-600m-otherside-nft-land-sale-records-highest-gas-fees-ever-on-ethereum) to really spike transaction fees.\n\nBecause transactions on Layer 2 confirm quickly and are inexpensive to execute, many of the most innovative protocols are building on L2s. Unless you’ve been in the ecosystem for a while, however, it’s not intuitive to know how to start using Layer 2s. But there is a clear place to begin your journey into Ethereum scaling solutions: funding your `wallet` on Layer 2.\n\nThere are three main ways to fund an L2 wallet: moving your crypto from a `centralized exchange` straight to a Layer 2 network, using a third-party crypto payment service to fund an L2 wallet, or sending your digital assets from Mainnet to L2 via a bridging protocol.\n\n> Please note, you’ll need to have a cryptocurrency wallet, like [MetaMask](https://metamask.io/) or [Tally Ho](https://tallyho.org/), and an Ethereum wallet `address` to proceed. If you haven’t yet created a `non-custodial wallet`, please [take this lesson first](https://app.banklessacademy.com/lessons/wallet-basics)!\n>\n> After you have a non-custodial Ethereum wallet address, you’ll be ready to continue on your crypto journey.\n\n## Funding From CEXs\n\nFunding your wallet directly from a centralized exchange (CEX) is perhaps the simplest way to move digital assets to an L2, particularly if you already hold cryptocurrency on the exchange. Most major CEXs offer users this option, although it isn’t always clear to the user.\n\nOn [Coinbase](https://www.coinbase.com/), for example, users can send their funds directly to Optimism or Polygon in just a few steps:\n\n1\. Go to [Coinbase](https://www.coinbase.com/).\n\n2\. [Purchase](https://help.coinbase.com/en/coinbase/trading-and-funding/buying-selling-or-converting-crypto/how-do-i-buy-digital-currency) or hold ETH on Coinbase.\n\n3\. Select ‘Send & Receive’, located at the top of the website.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-06c6d84b.png)\n\n4\. Enter the amount in fiat or ETH you wish to send (you can toggle between fiat and crypto to the right of the amount), select ‘Pay with’ and choose Ethereum, and in the ‘To’ field, enter the wallet address where the funds will be sent. Select ‘Continue’.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-98f7b580.png)\n\n5\. On the next screen, select ‘Network’ and change the network from Ethereum to Optimism.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-41c2bf0b.png)\n\n6\. Review, and if accurate, select ‘Send Now’.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-1c8e8c0a.png)\n\nMost major exchanges offer users the ability to send their crypto directly to an L2. [Binance](https://www.binance.com/) supports Optimism and Arbitrum, for example. On whatever centralized exchange you convert fiat to crypto, check to see whether it offers support for direct-to-L2 services. Pro Tip: Use [Blockscan](https://blockscan.com/exchanges) to find the exchange compatible with your preferred L2.\n\n## Third-Party Onramps\n\nAnother simple way to fund your L2 wallet is to take advantage of direct-to-L2 services offered by many third-party crypto payment companies. [MoonPay](https://www.moonpay.com/), [Ramp](https://ramp.network/buy/), and [Transak](https://global.transak.com/) are three of the most popular options to fund crypto wallets without having to use a centralized exchange.\n\nLike most exchanges, these third-party onramps will require you to provide Know-Your-Customer information. However, once you get past those basic hurdles, these payment options are an easy way to buy crypto across the ecosystem and transfer it to Layer 2.\n\nFor MoonPay, the steps are:\n\n1\. Go to [MoonPay](https://www.moonpay.com/).\n\n2\. Select ‘Buy crypto’, located at the top or middle of the website.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-c61b0868.png)\n\n3\. Enter the amount of fiat you wish to send and the proper denomination.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-b17f3ab3.png)\n\n4\. Select a digital asset, in this case ETH. Type in “ETH\'“ and you will see different networks on which you can purchase ETH (you may need to scroll down); choose the Layer 2 you want to use. Click ‘Continue’.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-7772e5a5.png)\n\n5\. Next, you will be prompted to enter personal verification and payment data.\n\n6\. Once complete, enter your Ethereum wallet address. You’ll be asked to make sure the wallet is safe to use.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-9a988bf2.png)\n\n7\. Complete, confirm the information is correct, and select ‘Pay’.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-10834d80.png)\n\nAs with CEXs, most major third-party payment onramps provide direct-to-L2 functionality. Take advantage of these innovations to save on transaction fees and increase the range of your `blockchain` explorations.\n\n## Funding Via Bridges\n\nIf you already have funds on Ethereum Mainnet, by far the easiest way to get your crypto on to L2 is to use a bridging protocol. Bridges are the name we’ve given to protocols designed to help us move our funds around the cryptoverse, and there are a number of bridges designed to move crypto from Ethereum Mainnet to Layer 2s.\n\n### Native Bridges\n\nNative bridges are those designed by the Layer 2 protocols themselves. For true Layer 2 scaling solutions like Arbitrum and Optimism, it takes about 30 minutes to move funds onto L2, but one week to move that crypto back over to Mainnet. The [Arbitrum Bridge](https://bridge.arbitrum.io/) and the [Optimism Bridge](https://app.optimism.io/bridge/) both take longer to transfer assets and settle transactions because of the way the scaling solution is designed.\n\n### Third-Party Bridges\n\nBecause no one likes to wait, a number of third-party bridging services exist to help us move our funds instantly to and from L2s. Among the most popular options are [Hop Protocol](https://app.hop.exchange/) and [Across Protocol](https://across.to/bridge), but you can use [Bungee](https://bungee.exchange/) to compare bridging fees across a number of protocols. To use Across, for example, all you need to do is:\n\n1\. Go to the [Across Protocol](https://across.to/bridge) bridge and connect your wallet.\n\n2\. To bridge funds to L2, select Ethereum under ‘From’.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-865879a7.png)\n\n3\. Choose your asset and the amount you wish to bridge (Pro Tip: only bridge a blockchain’s native `coin`, in this case ETH).\n\n![](/lesson/images/how-to-delegate-on-optimism/image-ec8932e6.png)\n\n4\. Next, select your L2 solution in ‘To’.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-f84f6380.png)\n\n5\. Review the transaction, and if all looks correct, select ‘Send’.\n\n![](/lesson/images/how-to-delegate-on-optimism/image-0492a872.png)\n\nMoving funds from Mainnet to L2 is really that simple, and nearly all bridges work the same way. Select a blockchain to send funds from and your destination, pick an asset and amount, and across the blockchain crevice you go. Pro Tip: As with sending from a CEX, you can use [Blockscan](https://blockscan.com/bridges) to find a compatible bridge for your L2 destination.\n\n## The Road to L2\n\nLayer 2s offer users of all experience levels the opportunity to experiment with decentralized finance in a way that is often prohibitive on Mainnet. Because it costs mere pennies to transact on these networks (you can compare costs [here](https://l2fees.info/)), it’s a great place to become familiar with the basic building blocks of decentralized finance, such as swaps, `liquidity pools`, or yield farms.\n\nUsing a CEX or a bridge to move funds to L2 is a necessary step in your journey from crypto novice to crypto competency. Remember, to see your funds displayed in your wallet, you may need to add the network in your wallet settings, which can be done at [Chainlist](https://chainlist.org/). If you just want to check that the funds made it safely to your L2 wallet, you can also check Etherscan (click on the ‘b’ for ‘Blockscan’ to the right of your wallet address to see L2 transactions) or go to a DEX, like [Uniswap](https://app.uniswap.org/), and select the L2 network and the asset to see your balance.\n\nAs you scale up your skills, you’ll need to figure out how to scale down your transaction fees. Learning how to fund an L2 wallet is the first step, but the next steps on your crypto journey are up to you. Welcome, explorer, a new world awaits.\n\n\n***\n\n**Author**\n\n**[Hiro Kennelly](https://twitter.com/HiroKennelly)** is a writer, editor, and coordinator at BanklessDAO and the Editor-in-Chief at Good Morning News. He is also helping to build a grants-focused organization at DAOpunks.\n\n**Editor**\n\n**[Trewkat](https://twitter.com/trewkat)** is a writer and editor at BanklessDAO. She’s interested in learning as much as possible about crypto and NFTs, with a particular focus on how best to communicate this knowledge to others.',
    imageLinks: [
      '/lesson/images/how-to-delegate-on-optimism/image-06c6d84b.png',
      '/lesson/images/how-to-delegate-on-optimism/image-98f7b580.png',
      '/lesson/images/how-to-delegate-on-optimism/image-41c2bf0b.png',
  ...
  {
    badgeImageLink: 'https://placehold.co/600x600/4b4665/FFFFFF?text=Bankless+Archetypes',
    lessonImageLink: 'https://placehold.co/1200x600/4b4665/FFFFFF?text=Bankless+Archetypes',
    learningActions: '',
    marketingDescription: '',
    badgeId: null,
    duration: null,
    ...
    socialImageLink: 'https://placehold.co/1200x600/4b4665/FFFFFF?text=Bankless+Archetypes',
    imageLinks: [],
    slides: [
      {
        type: 'LEARN',
