    ...
    slides: [
      {
        ...
        content: '<div class="bloc1"><p>Welcome, bold Explorer, to the frontier of digital innovation.</p><p>At Bankless Academy, our mission is to provide Explorers such as yourself with the best tools and knowledge to navigate the blockchain universe and “go bankless!”</p><p>Today, we’re looking at the <code>cryptocurrency</code> that started it all: Bitcoin.</p><p>Bitcoin is a new type of money, designed to resist <code>inflation</code>: its supply is fixed in code, so no one can print more of it. Its price still swings in the short term, but its rules never change.</p></div><div class="bloc2"><img src=\'/images/bitcoin-basics/welcome-to-bankless-academy-cc6189d4.png\'></div>'
      },
      {
        type: 'LEARN',
