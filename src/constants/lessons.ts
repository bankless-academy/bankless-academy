...
const LESSONS: LessonType[] = [
  ...
  },
  {
    ...
    imageLinks: [
      '/lesson/blockchain-fundamentals/introduction-294fb48a.svg',
      '/lesson/blockchain-fundamentals/blockchain-structure-b71adef9.svg',
      '/lesson/blockchain-fundamentals/examining-the-ledger-5946d539.svg',
      '/lesson/blockchain-fundamentals/transactions-on-the-ledger-225f512a.svg',
      '/lesson/blockchain-fundamentals/block-anatomy-2488c960.svg',
      '/lesson/blockchain-fundamentals/inside-a-block-dd00c1f2.svg',
      '/lesson/blockchain-fundamentals/individual-transactions-923752bc.svg',
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>In typical money systems, we trust third parties like banks to keep track of how much money each person has. But we want a system that doesn’t require us to trust one entity to manage the ledger.</p><p>The <span class="tooltip" definition="The record of all transactions that have ever occurred.">ledger</span> is the list of ALL transactions ever made on a blockchain, and anyone can see it for <span class="tooltip" definition="Public blockchains allow anyone to view the blockchain ledger">public</span> blockchains. </p><p>When new transactions are added to the ledger, balances stored at each <span class="tooltip" definition="Unique public identifier for an entity on a blockchain">address</span> get updated; past transactions cannot be altered. It’s like allowing everyone to look at everyone’s all-time bank account transaction history, at any given time, forever. </p></div><div class="bloc2"><img src=\'/lesson/blockchain-fundamentals/examining-the-ledger-5946d539.svg\'></div>'
      },
      {
        type: 'LEARN',
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        title: '✅ quiz',
        quiz: {
          question: 'Unlike in web2, in web3, scammers only need your seed phrase to steal everything in your wallet, including tokens and NFTs.',
          rightAnswerNumber: 1,
          answers: [
            'True',
            'False'
      ...
      },
      {
        ...
        quiz: {
          ...
          rightAnswerNumber: 4,
          answers: [
            'You only have to remember your master password to use them',
            'They generate and store strong, unique passwords for you',
      ...
      },
      {
        ...
        quiz: {
          ...
          rightAnswerNumber: 2,
          answers: [
            'It’s impossible to hack your account when you use 2FA',
            'It adds another layer of security to your web2 accounts',
      ...
      },
      {
        ...
        title: '✅ quiz',
        quiz: {
          question: 'What are some ways scammers use social engineering?',
          rightAnswerNumber: 4,
          answers: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Besides social engineering, the second most common attack is getting sent a bunch of scamtokens. These are tokens that scammers send to many people at once in the hopes that someone will try to move or sell the tokens and trigger the code hiding in the malicious smart contract of that token.</p><p>Malicious contracts can ask you to spend far more ETH than is necessary in order to sell these scamtokens, and others can completely drain your wallet! <a href=\'https://twitter.com/singularityhack/status/1515002012345188353\'>These scamtokens could even be NFTs</a>.</p><p>If the problem isn’t with the smart contract itself, these tokens will often lure victims back to phishing websites where scammers again try to trick victims to approve spending a different token or entering their <span class="tooltip" definition="Group of random words generated by a wallet on setup, they act as the master key to ALL accounts controlled by that wallet. NEVER SHARE YOUR SEED PHRASE WITH ANYONE FOR ANY REASON.">seed phrase</span>. </p><p>The best thing to do when you receive random tokens is to not interact with them at all; leave them alone and never touch them.</p></div>'
      },
      {
        type: 'QUIZ',
        ...
        title: '✅ quiz',
        quiz: {
          question: 'What are some of the dangers of interacting with scamtokens?',
          rightAnswerNumber: 4,
          answers: [
