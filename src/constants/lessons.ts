  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>We call them <code>centralized services</code> because all the power is in one place. It’s often like being stuck under the rule of a king who knows exactly how to get what he wants from you. You might be surprised at the reality of your trades…</p><p>💸 Banks charge fees, then invest your savings for their own profit.</p><p>💳 Payment networks, like Visa & Mastercard, sell your purchase data to advertisers.</p><p>📞 Social platforms, like Instagram, can view your private conversations.</p><p>🪓 Content platforms, like YouTube, can freely delete creators’ entire careers — with no fair trial.</p><p>These shady rules and fees are often hidden away in the ‘Terms & Conditions’. Take a closer look at your favourite service agreements here: <a href=\'https://tosdr.org/\'>https://tosdr.org/</a> 👀</p></div><div class="bloc2"><img src=\'/images/ethereum-basics/one-sided-trades-8d68270f.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>⚖️ <strong>Wouldn’t the internet be a better place if the same rules applied to everyone?</strong></p><hr><p>Think of Ethereum like an internet shopping mall, where shops, security, accounting and rent are fully automated.</p><p>“High-tech vending machines” have replaced traditional services. With transparent programming, users can review trade terms, or audit the machine’s business practices.</p><p>Transactions in the mall are noted on a public record called the <code>Ethereum blockchain</code>. The blockchain tracks and stores digital property in the mall, removing the need for another classic intermediary — the bank!</p><p>Even the \'landlord\' role is played by the community. Rules are decided on by active participants, and instead of rent, a small tax on each transaction keeps things running.</p><p>On Ethereum, nobody is above the rules.</p></div><div class="bloc2"><img src=\'/images/ethereum-basics/ethereum-the-open-internet-ab794154.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: '1b86dffae9cc4577929e0107a0a2f30b',
        title: 'The Decentralized Economy',
        content: '<div class="bloc1"><p>To log into Ethereum you’ll use your computer or mobile device’s web browser. You’ll only need one account for the entirety of this new internet — a single login called a <code>crypto wallet</code>. This setup makes it easier to change services and escape “walled gardens”.</p><p>With the Ethereum app layer enabled, new websites with Ethereum functionality immediately grant you access to limitless digital goods and services. On Ethereum, the “high-tech vending machine” services we mentioned are called <code>dApps</code>. Much like regular apps for your device, there are dApps for:</p><ul><li>🤝 sending or trading currencies, stocks and other digital goods, but with low fees and 24/7 service.</li><li>📻 connection with your favourite creators, but you can unlock unique perks and opportunities while ensuring your money goes directly to the artist.</li><li>👪 social media, but if you dislike the platform you can easily transfer your social circle to a new one.</li><li>🗳️ donating to your favourite projects, but even a $1 donation receives a large matching bonus.</li><li>⚙️ renting out your computer’s processing power for passive income.</li></ul><p>By removing intermediaries, banks, landlords, and individual accounts for each service, Ethereum has built a <code>decentralized</code> economy (this is the “d” in “dApp”). Without intermediaries, services get better and better as they compete on quality — not unclear business practices and control.</p></div>'
      },
      {
        type: 'LEARN',
        notionId: 'b148c5eff8a24e6fbe27c9423305c698',
        title: 'Using a dApp',
        content: '<div class="bloc1"><p>Using <code>dApps</code> is similar to using regular apps and internet services, but with a few differences.</p><p>Let’s simulate using a dApp for swapping <code>cryptocurrencies</code> online.</p><ol><li>Connect your <code>crypto wallet</code> to the dApp’s website.</li><li>Confirm the connection inside your Ethereum wallet.</li><li>Swap 50 DAI for 0.015 ETH, Ethereum’s native currency.</li><li>Submit the swap.</li><li>In your wallet, check the terms of your trade, and then sign.</li><li>Great! Your swap is being processed on Ethereum and will finalize shortly.</li></ol><p>Plugging your wallet into a dApp and swapping cryptocurrencies is that easy. Now you can send it to friends, use it to make purchases, or try other financial service dApps.</p></div><div class="bloc2"><iframe allowfullscreen class=\'animation\' src=\'https://app.banklessacademy.com/animation/send\'></iframe></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>⌛ <strong>Do you want a faster, cheaper way to transfer money internationally?</strong></p><hr><p>With the power of Ethereum, you can send and store <code>cryptocurrencies</code> without intermediaries too. You’ll discover better services at lower cost through its automated banking system.</p><p>⚡ With the power of cryptocurrency, money can be sent anywhere for as little as $0.01, and settle in seconds. Compare this to an international wire transfer, where banks charge 3-4% of your transfer in fees, and take 1-5 working days!</p><p>🔐 You’re the only person with access to your Ethereum account. There’s no intermediary loaning out your savings or controlling what you do with your money. Funds are stored in your personal <code>crypto wallet</code> — the same one you used to connect to a dApp earlier.</p><p>On Ethereum, you’re your own bank, and you feel like it!</p></div><div class="bloc2"><img src=\'/images/ethereum-basics/a-global-banking-system-5a241dfc.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: 'befa989e445846e0bd0ac488740154fb',
        title: 'Sending a Payment',
        content: '<div class="bloc1"><p>Let’s use another simulation to practice sending cryptocurrency. Try sending your 0.015 <code>ETH</code> to the Bankless Academy <code>crypto wallet</code>.</p><ol><li>Unlock your wallet.</li><li>Inside of your wallet, select send.</li><li>Adjust the amount to 0.015 ETH.</li><li>Confirm the token and amount.</li><li>In contacts, select banklessacademy.eth.</li><li>That’s it! Your international transfer is on the way. Your fee was ~$0.01, and no intermediary could stop you.</li></ol><p>With Ethereum wallets, you can own and send more than just cryptocurrency. Transferrable assets include any digital property that can be stored <code>onchain</code>. Digital art, club memberships, show tickets, stocks, website addresses, and even real-world property rights have made their way onto Ethereum.</p></div><div class="bloc2"><iframe allowfullscreen class=\'animation\' src=\'https://app.banklessacademy.com/animation/send\'></iframe></div>'
      },
      {
        type: 'QUIZ',
        ...
        title: '✅ Knowledge Check',
        quiz: {
          question: 'True or False: Ethereum can freeze your transfers and confiscate your digital assets.',
          rightAnswerNumber: 2,
          answers: [
            'True',
            'False'
      ...
      },
      {
        ...
        title: 'How it Works',
        content: '<div class="bloc1"><p>Let’s bring everything together by taking a quick look at how Ethereum makes it all possible.</p><p>As a <code>peer-to-peer</code> network, Ethereum is made up of computers spread across the world. These devices, known as <code>validator nodes</code>, have been volunteered by their owners to help run the network. Using automated software, a validator will process transactions and verify the results of others to prevent fraud. In doing so, the validator generates <code>ether</code> rewards for its owner.</p></div><div class="bloc2"><img src=\'/images/ethereum-basics/how-it-works-08c71cad.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: 'c112d4f50c8c488f88950a3e732f6148',
        title: 'How it Works (Pt. II)',
        content: '<div class="bloc1"><p>The transaction you submitted earlier was processed by these Ethereum network <code>validator nodes</code>.</p><ol><li>Your ETH transaction was submitted to the Ethereum Network.</li><li>A validator checked your transaction for errors. Other validators double-checked their results.</li><li>Your transaction was added to the network’s public ledger, the <code>Ethereum blockchain</code>.</li><li>We received your transferred ETH in our wallet.</li></ol><p>You might be wondering why these validators don’t just run off with your funds. The short answer is because Ethereum makes this virtually impossible. Your upcoming lesson, “Blockchain Basics”, will help you understand more.</p></div><div class="bloc2"><iframe allowfullscreen class=\'animation\' src=\'https://app.banklessacademy.com/animation/ethereum\'></iframe></div>'
      },
      {
        type: 'LEARN',
        notionId: 'e7766b4ed5d94c05962984e11ad62bc1',
        title: 'Common Questions',
        content: '<div class="bloc1"><details><summary>❓ How was Ethereum created?</summary>Ethereum launched in 2015. Initially managed by the Ethereum Foundation, it is now steered by a global community through <code>decentralized</code> governance. This distribution of power strengthens the network’s founding vision of an open internet.</details><details><summary>❓ Is Ethereum safe?</summary>While your digital property on Ethereum can’t directly be stolen, you can be tricked into sending it to scammers, or make simple mistakes that cost you money. Take our ‘Web3 Security’ lesson to learn how to protect yourself on the internet frontier!</details><details><summary>❓ Is Ethereum legal?</summary>Yes. Today, Ethereum\'s legality and adoption are so strong that even <a href=\'https://www.forbes.com/sites/lawrencewintermeyer/2024/07/25/ethereum-on-the-brink-of-market-transformation-as-etfs-get-green-light/\'>big businesses are investing in and using it</a>. Realistically, shutting down Ethereum would require unprecedented global coordination, akin to NATO-level efforts. This is due to its <code>decentralized</code> network structure.</details><details><summary>❓ Is Ethereum used for criminal activity?</summary><a href=\'https://www.chainalysis.com/blog/2023-crypto-crime-report-introduction/\'>Research performed by Chainalysis</a> shows that around 0.24% of cryptocurrency transactions were used for criminal activity in 2022. Ethereum’s high transparency makes it easy for investigators to track and prosecute criminals acting <code>onchain</code>.</details><details><summary>❓ Is Ethereum bad for the environment?</summary>As Ethereum’s daily usage grew, the community recognized its growing environmental impact and took steps to address it. This led to a network upgrade called \'The Merge\', <a href=\'https://www.newscientist.com/article/2369304-cryptocurrency-ethereum-has-slashed-its-energy-use-by-99-99-per-cent/\'>reducing Ethereum\'s energy consumption by 99.9%</a>. This feat showcases Ethereum\'s adaptability to the needs of its users!</details><details><summary>❓ How can I invest in Ethereum?</summary>To invest in Ethereum, you’ll have to own <code>ether</code> — the network’s native cryptocurrency. As the lifeblood of the Ethereum network, ether is used to own a financial share in the network’s success, make payments, and pay transaction fees. It can even be <code>staked</code> to run a network <code>validator node</code>, securing Ethereum in exchange for further ether rewards.</details></div>'
      },
      {
        type: 'POLL',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>💪 <strong>It’s time to take control of your digital life.</strong></p><hr><p>Welcome, Explorer, to the new internet.</p><p>Ethereum is eroding the walls that intermediaries have put up around their corners of the internet, transforming an economy of <code>value-extraction</code> into one of <code>value-creation</code>. It’s time for powerful yet fair online services, true ownership over your digital assets, bold new communities, transformative work opportunities, and more.</p><p>Bankless Academy is here to empower you as we move into this digital future. Ready to make your mark?</p><p>To start your journey you’ll need to create your <code>cryptocurrency wallet</code>. This is your passport to the world of Ethereum. We’ll set up yours in your next lesson, ‘Wallet Basics’.</p><p>Let’s get started.</p></div><div class="bloc2"><img src=\'/images/ethereum-basics/joining-the-movement-44086b0b.png\'></div>'
      }
    ]
  },
  {
