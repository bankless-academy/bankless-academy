...
const LESSONS: LessonType[] = [
  {
    badgeImageLink: '/lesson/images/wallet-basics/kudos-75d8aa76.png',
  ...
  {
    badgeImageLink: '/lesson/images/blockchain-basics/kudos-b0048cdb.png',
  ...
  {
    badgeImageLink: '/lesson/images/conceptos-basicos-de-blockchain/kudos-b0048cdb.png',
  ...
  {
    badgeImageLink: '/lesson/images/web3-security/kudos-d2f0df26.png',
  ...
  {
    badgeImageLink: '/lesson/images/layer-1-blockchains/kudos-66fa6447.png',
  ...
  {
    badgeImageLink: '/lesson/images/layer-2-blockchains/kudos-761ee1a2.png',
  ...
  {
    badgeImageLink: '/lesson/images/intro-to-defi/kudos-b4dab2d4.png',
  ...
  {
    badgeImageLink: '/lesson/images/decentralized-exchanges/kudos-ecf873d9.png',
  ...
  {
    badgeImageLink: '/lesson/images/dex-aggregators/kudos-ddb9db8b.png',
  ...
  },
  {
    ...
    imageLinks: [
      ...
      '/lesson/images/optimism-governance/incentivizing-public-goods-adc49d00.svg',
    ...
    slides: [
      ...
      },
      {
        ...
        title: '<strong>The Optimistic Vision</strong>',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>There are two houses in OP governance, with independent and shared responsibilities in directing the network. </p><p><strong>The Token House</strong> is responsible for managing network upgrades, incentives, and the treasury. It uses a stakeholder structure to incentivize growth of the network economy, and accrue stakeholder value. The house is also responsible for preserving decentralization — preventing capture of the network economy.</p><p><strong>The Citizens’ House</strong> allocates <code>RetroPGF</code> resources to community projects, according to the ‘Impact = Profit’ ethos, and helps to decide the parameters of citizenship. The house is incentivized to improve network quality-of-life, by funding public goods that improve the value of citizenship!</p><p>Both houses maintain network balance through specific duties, voting mechanics, and <code>veto</code> abilities. You can join either house, or both! Let’s take a closer look at their functions.</p></div><div class="bloc2"><img src=\'/lesson/images/optimism-governance/introducing-the-governing-houses-992f67be.png\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        title: '✅ Knowledge Check',
        quiz: {
          question: 'How does the Token House protect the network from governance capture?',
          rightAnswerNumber: 4,
          answers: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>New joiners to the Citizen House are currently onboarded by invitation, to slowly scale and refine the House’s process. Membership is marked by holding a Citizen Badge — a nontransferable <code>ERC-721</code> token.</p><p>Invitation can happen in a number of ways, but specific scaling methods have been known to change season to season:</p><ul><li>Citizen badgeholders may be granted an additional invite, to be shared with someone they deem of great benefit to the network.</li><li>Previous recipients of RetroPGF have been granted the opportunity to select one community member for Citizen status.</li><li>The Optimism Foundation has issued badges to project builders using the network.</li></ul><p>Each badgeholder has a single vote. Their voting power is non-transferrable, and cannot be delegated, in order to prevent accumulation of House power under a small number of citizens.</p></div>'
      },
      {
        type: 'QUIZ',
        ...
        title: '✅ Knowledge Check',
        quiz: {
          question: 'How does the Citizens’ House protect the network from governance capture?',
          rightAnswerNumber: 3,
          answers: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>We’re almost ready to get involved in OP governance. There’s one last thing to mention.</p><p>The OP vision doesn’t stop at a single <code>L2</code> blockchain. As result of the ability to <code>fork</code> a blockchain, this is a cloneable governance experiment. OP technology is built to be scaled across multiple L2s — and even into real world governance scenarios. OP calls it <strong>the Superchain</strong>.</p><p>Coinbase haw already cloned and begun contributing to this shared <code>open source</code> initiative, through the Base blockchain. This collaborative pooling of development resources increases infrastructure evolution, while funneling L2 transaction fees towards OP’s impact=profit ethos.</p><p>Members are required to abide by the OP governance process to continue their benefits. This sets an exciting economic vision, if we can build sustainable, community-oriented governance practices today!</p></div><div class="bloc2"><img src=\'/lesson/images/optimism-governance/now-think-even-bigger-0f29ab97.svg\'></div>'
      },
      {
        type: 'LEARN',
        notionId: '172e6effe6c1431883423ccb1c792cce',
        title: 'Shaping an Optimistic Future',
        content: '<div class="bloc1"><p>History has always been paved by the optimists of humanity — those that dared to think big, and act to achieve it.</p><p>By getting involved in innovative communities, using truly <code>trustless</code> & fair governance systems, we can continue a movement that has been developing since the dawn of humankind. Our diverse world deserves communication and coordination mechanisms that allow us to not only coexist, but achieve balance and thrive together at local, global, and online scales.</p><p>We can start our OP Governance journey by joining the Token House. Today’s (optional) quest is to purchase any amount of voting tokens, and assign them to the delegate who best represents your vision for Optimism.</p><p>While the Citizens’ House develops its onboarding procedures, you can begin your Citizen journey by getting involved in the <a href=\'https://gov.optimism.io/\'>OP community</a> forum — offering your unique contribution to the OP vision!</p></div><div class="bloc2"><img src=\'/lesson/images/optimism-governance/shaping-an-optimistic-future-d3be07e1.svg\'></div>'
      }
    ]
  },
  {
