...
const LESSONS: LessonType[] = [
  ...
  },
  {
    ...
    imageLinks: [
      '/lesson/conceptos-basicos-de-blockchain/introduccin-dd17f448.svg',
      '/lesson/conceptos-basicos-de-blockchain/estructura-de-la-blockchain-06363800.svg',
      '/lesson/conceptos-basicos-de-blockchain/examinando-el-ledger-a08c89ad.svg',
      '/lesson/conceptos-basicos-de-blockchain/transacciones-en-el-ledger-32f9f247.svg',
      '/lesson/conceptos-basicos-de-blockchain/anatoma-de-un-bloque-914b2bf9.svg',
      '/lesson/conceptos-basicos-de-blockchain/interior-de-un-bloque-b9ecc7c3.svg',
      '/lesson/conceptos-basicos-de-blockchain/transacciones-individuales-1df9a5c1.svg',
      '/lesson/conceptos-basicos-de-blockchain/direcciones-de-usuario-aedccc31.svg'
    ],
    slides: [
      {
        type: 'LEARN',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Una característica importante de las blockchains es que los datos de transacciones pasadas no pueden ser modificados después de haber sido incluidos en un bloque. Esto se debe a que cada bloque tiene un <code><strong>hash de bloque</strong></code> único, como una huella digital, que se utiliza para enlazar los bloques uno después de otro. Nadie puede cambiar las transacciones pasadas sin cambiar esa huella digital y la huella digital de CADA bloque que le sigue, ya que cada una depende de la anterior.</p><p>Entonces, cada <code><strong>bloque</strong></code> es simplemente un grupo de transacciones que se juntan en un archivo junto con el <code><strong>hash de bloque</strong></code> del mismo. Los bloques se encadenan entre sí porque cada uno hace referencia a la huella digital única del bloque anterior para formar una <em><strong>cadena de bloques</strong></em> conectados.</p></div><div class="bloc2"><img src=\'/lesson/conceptos-basicos-de-blockchain/anatoma-de-un-bloque-914b2bf9.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Recuerda, los datos de un <code><strong>bloque</strong></code> son simplemente un grupo de transacciones juntas. Al examinar un solo bloque, vemos una lista de transacciones y algunos datos sobre quién creó el bloque.</p><p>Siguiendo nuestro ejemplo anterior cuando discutíamos el libro mayor de la blockchain, ambas transacciones podrían estar agrupadas en un solo bloque o distribuidas en varios bloques a lo largo del tiempo. Pero sin importar en qué bloque se incluyan, eventualmente se agregarán todas al libro mayor general de la blockchain.</p><ul><li>Alice envía 5 ETH a Bob.</li><li>Bob envía 2 ETH a Charlie.</li></ul><p>Recuerda que cada bloque también debe hacer referencia al <code><strong>hash de bloque</strong></code> del bloque anterior para enlazar la blockchain.</p></div><div class="bloc2"><img src=\'/lesson/conceptos-basicos-de-blockchain/interior-de-un-bloque-b9ecc7c3.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Los datos en cualquier blockchain son simplemente una lista de <code><strong>transacciones</strong></code>, registros de moneda transferida entre usuarios. Cada transacción debe estar firmada con la <code><strong>firma digital</strong></code> del remitente para ser válida.</p><p>Esto es lo que haces cuando confirmas una transacción con una billetera, estás firmando con tu firma digital para autorizar la transacción. Puedes pensar en ello como el equivalente digital de firmar físicamente un cheque, un recibo o una transacción con tarjeta de crédito.</p><p>Las transacciones pueden ser simples, como enviar activos de criptomonedas, o más complejas, como intercambiar activos de criptomonedas o incluso desplegar código especial que se ejecuta cuando se activa, llamado <code><strong>contratos inteligentes</strong></code>.</p><p>Finalmente, cada transacción tiene un identificador digital único, llamado su <code><strong>hash de transacción</strong></code>, que ninguna otra transacción tiene. Esto facilita referirse a cualquier transacción individual más adelante y garantiza que los detalles de esa transacción no se puedan cambiar posteriormente.</p></div><div class="bloc2"><img src=\'/lesson/conceptos-basicos-de-blockchain/transacciones-individuales-1df9a5c1.svg\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Una <code><strong>dirección</strong></code> es un identificador público al que cualquiera puede acceder en la blockchain. Al igual que una dirección de correo electrónico, cualquier persona puede enviar fondos a ella, pero solo alguien que controle la <code><strong>clave privada</strong></code> puede desbloquear y utilizar los fondos en esa dirección.</p><p>En Ethereum, una dirección siempre comienza con <em>0x_________</em> y consta de 42 caracteres de números y letras derivados de la <code><strong>clave pública</strong></code> de esa dirección.</p><p>Cuando observamos una transacción individual en un explorador de bloques, podemos ver las direcciones \'De:\' y \'Para:\'. Esto no nos dice quiénes son las <em>personas</em> que controlan esas direcciones, pero permite a cualquier usuario rastrear el movimiento de criptomonedas en el ledger de la blockchain.</p></div><div class="bloc2"><img src=\'/lesson/conceptos-basicos-de-blockchain/direcciones-de-usuario-aedccc31.svg\'></div>'
      },
      {
        type: 'QUIZ',
  ...
  },
  {
    ...
    lessonImageLink: '/lesson/decentralized-exchanges/lesson-a006bb73.png',
