    ...
    slides: [
      {
        ...
        content:
          '<ul><li>A <span class="tooltip" definition="A wallet is an application or device used to send and receive cryptocurrency" style="color:green">wallet</span> acts as a <strong>gateway</strong> into the world of crypto assets.</li><li>A <span class="tooltip" definition="A wallet is an application or device used to send and receive cryptocurrency" style="color:green">wallet</span> acts as <strong>your account</strong> on the blockchain.</li><li>A <span class="tooltip" definition="A wallet is an application or device used to send and receive cryptocurrency" style="color:green">wallet</span> can <strong>break through data / application silos, </strong>leading to a more free internet.</li></ul>',
      },
      {
        type: 'LEARN',
        title:
