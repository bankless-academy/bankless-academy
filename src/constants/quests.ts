...
const QUESTS: QuestType[] = [
  {
    ...
    slides: [
      ...
      },
      {
        ...
        title: 'What are keys?',
        content:
          '<div class="bloc1"><p>Recall that your <span class="tooltip" definition="A recovery phrase is a list of 12 to 24 words which is used to generate your wallet\'s public key and private key." style="color:rgba(128, 128, 128, 1)">recovery phrase</span> is used to generate pairs of <span class="tooltip" definition="A public key is your address. It gives others a point of reference to send crypto assets to you." style="color:rgba(0, 120, 223, 1)">public keys</span> and <span class="tooltip" definition="A private key allows access to your wallet in order for you to send crypto assets to other address." style="color:rgba(255, 0, 26, 1)">private keys</span> for your wallet.</p><p> A wallet can have multiple accounts, and <strong><em>each account</em></strong> has a unique pair of keys. There is a <span class="tooltip" definition="A public key is your address. It gives others a point of reference to send crypto assets to you." style="color:rgba(0, 120, 223, 1)">public key</span> and a <span class="tooltip" definition="A private key allows access to your wallet in order for you to send crypto assets to other address." style="color:rgba(255, 0, 26, 1)">private key</span> for each account.</p></div>',
      },
      {
        type: 'LEARN',
        title: 'What are keys?',
        content:
          '<div class="bloc1"><p>You can think of the <span class="tooltip" definition="A public key is your address. It gives others a point of reference to send crypto assets to you." style="color:rgba(0, 120, 223, 1)">public key</span> like your home address.</p><p>It\'s called public because anyone can see it.</p><p>Public keys allow others to identify you in order to send crypto assets to your address.</p></div><div class="bloc2"><img src=\'https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F2478044f-5a9b-4096-82fd-6f473e300b06%2FPublic_key_-_Medium.png?table=block&id=28677d9c-e015-4239-8749-fe9780269277\'></div>',
      },
      {
        type: 'LEARN',
        title: 'What are keys?',
      ...
      },
      {
        ...
        content:
          '<div class="bloc1"><p>Recall that <span class="tooltip" definition="A private key allows access to your wallet in order for you to send crypto assets to other address." style="color:rgba(255, 0, 26, 1)">private keys</span> let you access your <span class="tooltip" definition="A wallet is an application or device used to send and receive crypto assets on the blockchain." style="color:rgba(128, 128, 128, 1)">wallet</span> to send crypto. In almost all cases, you want to own and secure your wallet’s private key.</p><p>But not all wallets will let you do that. With a <span class="tooltip" definition="With a custodial wallet, another party controls the private keys, thus controlling access to your crypto assets." style="color:rgba(255, 0, 26, 1)">custodial wallet</span>, another party controls your private keys.</p><p>Think of your account on Coinbase Exchange or Kraken Exchange, they are examples of custodial wallets.</p><p>You’re trusting a third party to secure your funds and return them to you if you want to trade or send them somewhere else.</p></div><div class="bloc2"><img src=\'https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Ff47717ea-bdf4-4da4-87ca-6d9f080c33f5%2F435454C9-01C1-4393-BA2C-D5D126BD72A5.jpg?table=block&id=c4b3f36a-a021-4643-8cb5-73587c560966\'></div>',
      },
      {
        type: 'LEARN',
        title: 'Not your keys, not your crypto!',
      ...
      },
      {
        type: 'LEARN',
        title:
          'Types of non-custodial wallets: <span class="tooltip" definition="A type of non-custodial wallet that is perpetually connected to the internet." style="color:rgba(255, 0, 26, 1)">hot wallets</span>',
        content:
          '<div class="bloc1"><p>There are 2 major types of <span class="tooltip" definition="With a non-custodial wallet, you have sole control of your private keys, which in turn control your crypto assets." style="color:rgba(0, 135, 107, 1)">non-custodial wallets</span> : <span class="tooltip" definition="A type of non-custodial wallet that is perpetually connected to the internet." style="color:rgba(255, 0, 26, 1)">hot wallets</span> and <span class="tooltip" definition="A type of non-custodial wallet that is stored offline and does not require a perpetual internet connection." style="color:rgba(0, 120, 223, 1)">cold wallets</span></p><p>A <span class="tooltip" definition="A type of non-custodial wallet that is perpetually connected to the internet." style="color:rgba(255, 0, 26, 1)">hot wallet</span>Perpetually connected to the internet.</p><ul><li>PROS 👍: They are usually free, simple to set up, and easy to use.</li><li>CONS 👎: They are less secure due to internet connection.</li></ul></div><div class="bloc2"><img src=\'https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F6d21b889-010f-4c00-982c-b76eff6f5669%2FHot_Wallet_-_Medium.png?table=block&id=5d6cf632-8807-4023-894a-405baacc3000\'></div>',
      },
      {
        type: 'LEARN',
        title:
          'Types of non-custodial wallets: <span class="tooltip" definition="A type of non-custodial wallet that is stored offline and does not require a perpetual internet connection." style="color:rgba(0, 120, 223, 1)">cold wallets</span>',
        content:
          '<div class="bloc1"><p>A <span class="tooltip" definition="A type of non-custodial wallet that is stored offline and does not require a perpetual internet connection." style="color:rgba(0, 120, 223, 1)">cold wallet</span>is <strong>never</strong> connected to the internet.</p><ul><li>PROS 👍: They are more secure.</li><li>CONS 👎: They aren\'t free, sometimes cumbersome to use, and are not ideal for quick transactions.</li></ul></div><div class="bloc2"><img src=\'https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fdb7cdb4f-1eee-4bbf-a78f-66fb32c7bbfa%2FCold_Wallet_-_Medium.png?table=block&id=7b3c4e32-583e-45f2-9af1-7406f8a7b5d9\'></div>',
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content:
          '<div class="bloc1"><p>MetaMask is one of many non-custodial <span class="tooltip" definition="A type of non-custodial wallet that is perpetually connected to the internet." style="color:rgba(255, 0, 26, 1)">hot wallets</span></p><ul><li>It is a widely used wallet with over 5 million monthly active users so it is more likely to be compatible with your preferred <span class="tooltip" definition="An abbreviation for decentralized finance, defi is a system by which financial products become available on a public decentralized blockchain network" style="color:rgba(128, 128, 128, 1)">DeFi</span> apps.</li><li>A browser extension is available on Chrome, Brave, Edge, and Firefox internet browsers.</li><li>Also available as mobile app for Android and IOS users.</li></ul></div>',
      },
      {
        type: 'QUIZ',
