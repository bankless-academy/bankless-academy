...
across many of them. **Use exactly the Ukrainian in this table. Do not
...
| English heading | Ukrainian | occurrences |
|---|---|---|
| `Key Takeaways` | `Ключові висновки` | 7 |
| `Introduction` | `Вступ` | 6 |
| `Walkthrough` | `Покрокова інструкція` | 3 |
| `FAQ` | `Часті запитання` | 3 |
| `Frequently Asked Questions` | `Часті запитання` | 3 |
| `Prerequisites` | `Що потрібно заздалегідь` | 2 |
| `Choosing a DEX` | `Як обрати DEX` | 2 |
