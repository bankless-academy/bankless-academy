...
across many of them. **Use exactly the Spanish in this table. Do not
...
| English heading | Spanish | occurrences |
|---|---|---|
| `Key Takeaways` | `Puntos clave` | 7 |
| `Introduction` | `Introducción` | 6 |
| `Walkthrough` | `Guía paso a paso` | 3 |
| `FAQ` | `Preguntas frecuentes` | 3 |
| `Frequently Asked Questions` | `Preguntas frecuentes` | 3 |
| `Prerequisites` | `Requisitos previos` | 2 |
| `Choosing a DEX` | `Cómo elegir un DEX` | 2 |
