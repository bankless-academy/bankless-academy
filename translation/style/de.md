...
across many of them. **Use exactly the German in this table. Do not
...
| English heading | German | occurrences |
|---|---|---|
| `Key Takeaways` | `Wichtigste Erkenntnisse` | 7 |
| `Introduction` | `Einführung` | 6 |
| `Walkthrough` | `Anleitung` | 3 |
| `FAQ` | `FAQ` | 3 |
| `Frequently Asked Questions` | `Häufige Fragen` | 3 |
| `Prerequisites` | `Voraussetzungen` | 2 |
| `Choosing a DEX` | `Die richtige DEX wählen` | 2 |
