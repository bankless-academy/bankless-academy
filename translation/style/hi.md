...
across many of them. **Use exactly the Hindi in this table. Do not
...
| English heading | Hindi | occurrences |
|---|---|---|
| `Key Takeaways` | `मुख्य बातें` | 7 |
| `Introduction` | `परिचय` | 6 |
| `Walkthrough` | `कदम-दर-कदम गाइड` | 3 |
| `FAQ` | `अक्सर पूछे जाने वाले सवाल` | 3 |
| `Frequently Asked Questions` | `अक्सर पूछे जाने वाले सवाल` | 3 |
| `Prerequisites` | `ज़रूरी तैयारी` | 2 |
| `Choosing a DEX` | `DEX कैसे चुनें` | 2 |
