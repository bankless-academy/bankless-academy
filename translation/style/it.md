...
across many of them. **Use exactly the Italian in this table. Do not
...
| English heading | Italian | occurrences |
|---|---|---|
| `Key Takeaways` | `Punti chiave` | 7 |
| `Introduction` | `Introduzione` | 6 |
| `Walkthrough` | `Guida pratica` | 3 |
| `FAQ` | `FAQ` | 3 |
| `Frequently Asked Questions` | `Domande frequenti` | 3 |
| `Prerequisites` | `Prerequisiti` | 2 |
| `Choosing a DEX` | `Come scegliere un DEX` | 2 |
