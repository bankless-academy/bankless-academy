...
across many of them. **Use exactly the Turkish in this table. Do not
...
| English heading | Turkish | occurrences |
|---|---|---|
| `Key Takeaways` | `Önemli Noktalar` | 7 |
| `Introduction` | `Giriş` | 6 |
| `Walkthrough` | `Adım Adım Rehber` | 3 |
| `FAQ` | `SSS` | 3 |
| `Frequently Asked Questions` | `Sık Sorulan Sorular` | 3 |
| `Prerequisites` | `Ön Koşullar` | 2 |
| `Choosing a DEX` | `DEX Seçmek` | 2 |
