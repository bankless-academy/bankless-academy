...
> * Las stablecoins son el equivalente en la blockchain del dinero fiat, como el dólar o el euro.
>
> * Suelen emitirse como tokens (por ejemplo, tokens `ERC-20` en Ethereum) y hoy circulan por muchas blockchains. Permiten a los usuarios de DeFi moverse rápido entre el valor fiat y el valor cripto, sin salir de la blockchain.
>
> * Hay varias categorías de stablecoin, cada una con sus propias ventajas, desventajas y perfil de riesgo.
>
> * Las stablecoins pueden generar más interés anual que guardar fiat en un banco tradicional, aunque hoy la regulación define quién puede ofrecer ese rendimiento y cómo.
...
> **Innovación y filantropía con stablecoins respaldadas por fiat: Glo Dollar**
>
> La Glo Foundation aplica un enfoque innovador a los ingresos de sus reservas con [Glo Dollar](https://www.glodollar.org/) (USDGLO), su stablecoin respaldada por el dólar: el interés que ganan sus reservas financia programas de renta básica para personas en pobreza extrema. Con solo tener USDGLO, los usuarios practican una filantropía integrada. Conoce cómo funciona Glo Dollar [aquí](https://www.glodollar.org/articles/how-glo-works).
...
![Composición del colateral de DAI, la predecesora de USDS (junio de 2023)](https://app.banklessacademy.com/images/understanding-stablecoins/image-573e657a.png)

Qué tener en cuenta:

* **Valoración del colateral:** las reservas de una stablecoin suelen incluir cripto, otras stablecoins e incluso otras clases de activos. Por ejemplo, USDS está respaldada por ETH, stablecoins, activos del mundo real como bonos del Tesoro de EE. UU. y varios componentes menores. Para reducir el riesgo de esa variedad de activos, USDS está sobrecolateralizada (al momento de escribir esto). Incluso si el precio del ETH se desplomara un 20 %, USDS seguiría teniendo [colateral suficiente](https://defillama.com/stablecoins) para cubrir sus tokens. Aun así, más volatilidad en su conjunto de activos podría empezar a erosionar la paridad.
...
El tema de los préstamos y los créditos merece su propia entrada en Bankless Academy. Si ya te interesa saber más, puedes investigar plataformas como [Aave.com](https://aave.com/) y [Curve.fi](https://curve.fi/).
...
**[Tetranome](https://twitter.com/tetranome)** es el Project Champion de Bankless Academy, y se enfoca en la experiencia de usuario, la interfaz, el diseño y el plan de estudios de la plataforma.
