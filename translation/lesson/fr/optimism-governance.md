...
Optimism a pour objectif de devenir un « quartier du cyberespace » qui subvient directement aux besoins de ses citoyens et qui est gouverné par eux !

# Knowledge Check 2

Lequel des éléments suivants n'est PAS un bien public ?

- [ ] Éducation

> ℹ️ L'éducation peut profiter à tout le monde, et l'utilisation d'une personne ne réduit pas sa disponibilité.

- [ ] Internet

> ℹ️ L'internet peut profiter à tout le monde et l'utilisation d'une personne ne réduit pas sa disponibilité.
...
3. Une partie de ces taxes sont attribuées aux constructeurs qui fournissent une infrastructure de biens publics ayant un impact considérable.
...
Pour protéger le réseau, la Maison des Citoyens a le droit d'opposer son `véto` à toute proposition entrant dans les catégories susmentionnées.
...
La gouvernance du réseau est aussi démocratique que la `distribution de jetons` initiale. Nous devrions toujours nous demander "qui a reçu le pouvoir de vote en premier lieu" et "combien ils ont reçu".
...
Optimism prend **une approche itérative de la gouvernance**, en utilisant une structure calendaire appelée "Saisons".

En passant de périodes de gouvernance active à des périodes de réflexion, les participants acquièrent une expérience de première main suivie d'une digestion et d'une discussion sur les pratiques de gouvernance actuelles. Le modèle est ensuite amélioré par la Fondation Optimism, et la saison suivante commence.
